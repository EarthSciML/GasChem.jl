...
# ╔═╡ 8ca149fa-1bf4-4fd9-9b2e-e19b0544c173
function u1()
	n=0
	m=""
	u_dms = [-0.119651
...
0.0109903
0.00929881]
	test1 = ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 76, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)-ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 46, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)
	compare1 = u_dms-test1
	if isapprox(test1, u_dms, atol=0.001) == true
...
# ╔═╡ a1e1f5bc-d7ac-4215-8f44-71d1c84822f5
u1()

# ╔═╡ 345567a8-f6c2-4494-93d1-4c6fd1860985
md"""
### Unit Test 2
ISOP sensitivity
"""

# ╔═╡ 8f2d5d24-137c-49f7-a694-6640c11f5fbf
function u2()
	n=0
	m=""
	u_isop = [0.162031
...
0.104439
-0.196991]
	test2 = ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 50, 2.0, 0.54, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)-ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 50, 2.0, 0.13, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)
	compare2 = u_isop-test2
if isapprox(test2, u_isop, atol=0.001) == true
		m = "unit test 1 passed"
	else 
		m = "unit test 1 failed"
	end
...
# ╔═╡ 03d8751e-dae6-4200-9c4c-1fa4229752a6
u2()

# ╔═╡ 41fb393c-d9dd-4250-af5c-0b7ffbd18c7f
md"""
### Unit Test 3
NO2 sensitivity
"""

# ╔═╡ f244613e-7a73-41a3-80dd-50b6c58d2513
function u3()
	n=0
	m=""
	u_no2 = [46.0443
...
-2.22193e-6
-2.24779]
	test3 = ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 100.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 0.1, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)-ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 275.0, 1.6, 0.0, 0.1, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)
	compare3 = u_no2-test3
if isapprox(test3, u_no2, atol=0.001) == true
...
# ╔═╡ 3c5a83a5-9c66-4638-a0ee-856668284367
u3()

# ╔═╡ f3abdba5-3045-427a-aed9-28b8f05a9614
md"""
### Unit Test 4
CO sensitivity
"""

# ╔═╡ 18cae0dd-c956-417e-a552-d72914c5d214
function u4()
	n=0
	m=""
	u_co = [-0.270119
...
-0.00262908
-0.269762]
	test4 = ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 50.0, 1.6, 0.0, 50, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)-ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1700.0, 0.01, 0.15, 500.0, 1.6, 0.0, 50, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)  
	compare4 = u_co-test4
if isapprox(test4, u_co, atol=0.001) == true
...
# ╔═╡ 96c8da46-de1c-40d7-a6bd-82fe69464260
u4()

# ╔═╡ 988ef998-8193-48db-bacb-f4097ca182d3
md"""
### Unit Test 5
CH4 sensitivity
"""

# ╔═╡ 496472b1-4e6c-4629-abf2-a76d98882dbc
function u5()
	n=0
	m=""
	u_ch4 = [0.00678343
...
6.41573e-5
-0.00423393]
	test5 = ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1900.0, 0.01, 0.15, 275.0, 1.6, 0.0, 50, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)-ozone_(280,10.0, 10.0, 10.0, 2.1*(10^8), 450.0, 0.0, 10.0, 1600.0, 0.01, 0.15, 275.0, 1.6, 0.0, 50, 2.0, 0.15, 2.34, 1.0097*10^-5, 0.0149, 0.00014, 8.9573*10^-6)  
	compare5 = u_ch4-test5
if isapprox(test5, u_ch4, atol=0.001) == true
...
# ╔═╡ e5948218-50de-4f51-8d72-7e23a265c886
u5()
