@testsnippet RateLawSetup begin
    ...
    function compile_rate_law(rate_rs; extra_params = [], name = nameof(rate_rs))
        ...
        sys = Catalyst.ode_model(complete(wrapper); name = name)
...
@testitem "constant_k" setup = [RateLawSetup] begin
    c = 1.8e-12
    sys = compile_rate_law(GasChem.constant_k(t, T, num_density, c))
...
@testitem "constant_k_1" setup = [RateLawSetup] begin
    c = 1.8e-12
    sys = compile_rate_law(GasChem.constant_k_1(t, c))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "regress_T" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.regress_T(t, T, num_density, a_0, b_0, T_0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arrhenius_ppb" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.arrhenius_ppb(t, T, num_density, a0, b0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arrhenius_ppb_3" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.arrhenius_ppb_3(t, T, num_density, a0, b0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arrhenius_mlc_SI" setup = [RateLawSetup] begin
    a0, b0, c0 = 3.0e-12, 0.0, -1500.0
    sys = compile_rate_law(GasChem.arrhenius_mlc_SI(t, T, a0, b0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arrhenius_mlc_1" setup = [RateLawSetup] begin
    a0, b0, c0 = 3.0e-12, 0.0, -1500.0
    sys = compile_rate_law(GasChem.arrhenius_mlc_1(t, T, a0, b0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arr_3rdbody" setup = [RateLawSetup] begin
    ...
    fv = 0.6
    sys = compile_rate_law(GasChem.arr_3rdbody(t, T, num_density, a1, b1, c1, a2, b2, c2, fv))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
...
@testitem "arr_3rdbody_1" setup = [RateLawSetup] begin
    ...
    a2, b2, c2 = 2.6e-11, 0.0, 0.0
    fv = 0.6
    sys = compile_rate_law(GasChem.arr_3rdbody_1(t, T, num_density, a1, b1, c1, a2, b2, c2, fv))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_HO2HO2" setup = [RateLawSetup] begin
    ...
    a0, c0 = 3.0e-13, 460.0
    a1, c1 = 2.1e-33, 920.0
    sys = compile_rate_law(GasChem.rate_HO2HO2(t, T, num_density, H2O, a0, c0, a1, c1); extra_params = [H2O])
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_OHCO" setup = [RateLawSetup] begin
    sys = compile_rate_law(GasChem.rate_OHCO(t, T, num_density))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_RO2NO_a1" setup = [RateLawSetup] begin
    a0, c0 = 2.8e-12, 300.0
    sys = compile_rate_law(GasChem.rate_RO2NO_a1(t, T, num_density, a0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_RO2NO_b1" setup = [RateLawSetup] begin
    a0, c0 = 2.8e-12, 300.0
    sys = compile_rate_law(GasChem.rate_RO2NO_b1(t, T, num_density, a0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_RO2NO_a2" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_RO2NO_a2(t, T, num_density, a0, c0, a1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_RO2NO_b2" setup = [RateLawSetup] begin
    a0, c0, a1 = 2.6e-12, 365.0, 2.0
    sys = compile_rate_law(GasChem.rate_RO2NO_b2(t, T, num_density, a0, c0, a1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "tbranch" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.tbranch(t, T, num_density, a0, b0, c0, a1, b1, c1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_OHHNO3" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_OHHNO3(t, T, num_density, a0, c0, a1, c1, a2, c2))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "eq_const" setup = [RateLawSetup] begin
    ...
    a2, b2 = 9.3e-12, 1.5
    fv = 0.6
    sys = compile_rate_law(GasChem.eq_const(t, T, num_density, a0, c0, a1, b1, a2, b2, fv))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "eq_const_1" setup = [RateLawSetup] begin
    ...
    a2, b2 = 9.3e-12, 1.5
    fv = 0.6
    sys = compile_rate_law(GasChem.eq_const_1(t, T, num_density, a0, c0, a1, b1, a2, b2, fv))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
    @test k_val ≈ 2.1206340759025532e-27
end
...
@testitem "rate_RO2HO2" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_RO2HO2(t, T, num_density, a0, c0, a1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_GLYCOH_a" setup = [RateLawSetup] begin
    a0 = 3.1e-12
    sys = compile_rate_law(GasChem.rate_GLYCOH_a(t, T, num_density, a0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_GLYCOH_b" setup = [RateLawSetup] begin
    a0 = 3.1e-12
    sys = compile_rate_law(GasChem.rate_GLYCOH_b(t, T, num_density, a0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_HACOH_a" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_HACOH_a(t, T, num_density, a0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_HACOH_b" setup = [RateLawSetup] begin
    a0, c0 = 3.15e-14, 920.0
    sys = compile_rate_law(GasChem.rate_HACOH_b(t, T, num_density, a0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_DMSOH" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_DMSOH(t, T, num_density, a0, c0, a1, c1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_GLYXNO3" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_GLYXNO3(t, T, num_density, a0, c0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "arrplus_mlc_1" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.arrplus_mlc_1(t, T, a0, b0, c0, d0, e0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "arrplus_ppb" setup = [RateLawSetup] begin
    a0, b0, c0, d0, e0 = 1.0e-12, 298.0, 0.0, 1.0, 0.0
    sys = compile_rate_law(GasChem.arrplus_ppb(t, T, num_density, a0, b0, c0, d0, e0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "tunplus_mlc_1" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.tunplus_mlc_1(t, T, a0, b0, c0, d0, e0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "tunplus_ppb" setup = [RateLawSetup] begin
    a0, b0, c0, d0, e0 = 1.0e-12, 298.0, 1.0e8, 1.0, 0.0
    sys = compile_rate_law(GasChem.tunplus_ppb(t, T, num_density, a0, b0, c0, d0, e0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_ISO1" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_ISO1(t, T, num_density, a0, b0, c0, d0, e0, f0, g0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_ISO2" setup = [RateLawSetup] begin
    a0, b0, c0, d0, e0, f0, g0 = 1.0e-11, 390.0, 0.3, 1.0, 380.0, 1.0, 380.0
    sys = compile_rate_law(GasChem.rate_ISO2(t, T, num_density, a0, b0, c0, d0, e0, f0, g0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_EPO" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_EPO(t, T, num_density, a1, e1, m1))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_PAN_abab" setup = [RateLawSetup] begin
    ...
    cf = 0.3
    sys = compile_rate_law(GasChem.rate_PAN_abab(t, T, num_density, a0, b0, a1, b1, cf))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_PAN_acac" setup = [RateLawSetup] begin
    ...
    a1, c1 = 7.7e-12, 0.2
    cf = 0.6
    sys = compile_rate_law(GasChem.rate_PAN_acac(t, T, num_density, a0, c0, a1, c1, cf))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_NIT" setup = [RateLawSetup] begin
    ...
    sys = compile_rate_law(GasChem.rate_NIT(t, T, num_density, a0, b0, c0, n, x0, y0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
...
@testitem "rate_ALK" setup = [RateLawSetup] begin
    a0, b0, c0, n, x0, y0 = 2.9e-12, 350.0, 0.08, 1.0, 8.1e-4, 0.0
    sys = compile_rate_law(GasChem.rate_ALK(t, T, num_density, a0, b0, c0, n, x0, y0))
    prob = ODEProblem(sys, [], (0.0, 3600.0))
    k_val = getsym(prob, sys.k)(prob)
