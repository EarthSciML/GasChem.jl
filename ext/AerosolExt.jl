...
function EarthSciMLBase.couple2(
    ...
    # Vertical shape for the aerosol surface area (science audit: the S&P urban S_t is a
    # SURFACE value; holding it constant aloft over-drives het uptake 10-1000x in the free
