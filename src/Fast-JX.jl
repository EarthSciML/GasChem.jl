...
const σ_ClO = SA_F32[
    0, 0, 0, 0, 0, 0, 0, 0, 4.737e-18, 3.262e-18, 1.858e-18,
...
const σ_F115 = SA_F32[
    6.876e-21, 2.986e-21, 1.891e-21, 1.018e-21, 3.531e-22, 1.124e-22,
...
function adjust_j_o31D(T, P, H2O)
    consts = @constants begin
        ...
        ppb_unit = 1.0e-9, [unit = u"ppb", description = "Convert from mol/mol_air to ppb"]
    ...
    eqs = [
        ...
        C_H2O ~ H2O * ppb_inv * 1.0e-9 * num_density_unitless # convert value of H2O concentration in unit of ppb to unit of molec/cm3, but here is unitless
        ...
        RO1DplO2 ~ 3.3e-11 * exp(55.0 * T_unit / T) * C_O2
    ...
    return System(eqs, t, vars, consts, name = :AdjustJ_O31D)
end
