...
function constant_k(t, T, num_density, c; unit = u"ppb^-1*s^-1", name = :constant_k)
    ...
    consts = @constants begin
        ...
        ppb_unit = 1.0e-9, [unit = u"ppb^-1", description = "Convert from mol/mol_air to ppb"]
    end
...
function arr_3rdbody(
        t, T, num_density, a1, b1, c1, a2, b2, c2, fv; unit = u"ppb^-1*s^-1",
        name = :arr_3rdbody
    )
    t = ParentScope(t)
    T = ParentScope(T)
...
function arr_3rdbody_1(
        t, T, num_density, a1, b1, c1, a2, b2, c2, fv;
...
function rate_OHCO(t, T, num_density; name = :rate_OHCO)
    ...
    @named khi2 = arrhenius_mlc_SI(t, T, 2.1e+9, -6.1, 0)
...
function rate_RO2NO_a2(t, T, num_density, a0, c0, a1; name = :rate_RO2NO_a2)
    ...
    C = num_density * ppb_unit * unit_conv
    eqs = [
        xxyn ~ 1.94e-22 * exp(0.97 * a1) * num_density * num_density_unit_inv
...
"""
function eq_const(
        t, T, num_density, a0, c0, a1, b1, a2, b2,
...
"""
function eq_const_1(
        t, T, num_density, a0, c0, a1, b1, a2, b2, fv;
