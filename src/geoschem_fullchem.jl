...
function GEOSChemGasPhase(t)
    ...
    function arrnodim(T, a0, b0, c0)
        sys = arrhenius(t, T, a0, b0, c0, unit=u"nmol/mol"/u"nmol/mol", name=Symbol(:arrhenius, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    function arrsq(T, a0, b0, c0)
        sys = arrhenius(t, T, a0, b0, c0, unit=u"mol/nmol"^2, name=Symbol(:arrhenius, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    function arr3nodim(T, num_density, a1, b1, c1, a2, b2, c2, fv)
        sys = arr_3rdbody(t, T, num_density, a1, b1, c1, a2, b2, c2, fv; unit=u"nmol/mol"/u"nmol/mol", name=Symbol(:arr_3rdbody, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    function eqconstnodim(T, num_density, a0, c0, a1, b1, a2, b2, fv)
        sys = eq_const(t, T, num_density, a0, c0, a1, b1, a2, b2, fv; unit=u"nmol/mol"/u"nmol/mol", name=Symbol(:eq_const, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    function arrplsnodim(T, a0, b0, c0, d0, e0)
        sys = arrplus(t, T, a0, b0, c0, d0, e0; unit=u"nmol/mol"/u"nmol/mol", name=Symbol(:arrplus, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    function tunplsnodim(T, a0, b0, c0, d0, e0)
        sys = tunplus(t, T, a0, b0, c0, d0, e0;unit=u"nmol/mol"/u"nmol/mol",  name=Symbol(:tunplus, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    function rPAN_ababnodim(T, num_density, a0, b0, a1, b1, cf)
        sys = rate_PAN_abab(t, T, num_density, a0, b0, a1, b1, cf; unit=u"nmol/mol"/u"nmol/mol", name=Symbol(:rate_PAN_abab, i))
        i+=1
        push!(rate_systems, sys)
        return sys.k
    end
    ...
    rxn_sys = @reaction_network GEOSChemGasPhase begin
        ...
        @species(
            A3O2(t) = 59.469, [unit = u"nmol/mol", description = "CH3CH2CH2OO; Primary RO2 from C3H8"],
            ACET(t) = 87.473, [unit = u"nmol/mol", description = "CH3C(O)CH3; Acetone"],
            ACTA(t) = 70.187, [unit = u"nmol/mol", description = "CH3C(O)OH; Acetic acid"],
            AERI(t) = 30.013, [unit = u"nmol/mol", description = "I; Dissolved iodine"],
            ALD2(t) = 9.4976, [unit = u"nmol/mol", description = "CH3CHO; Acetaldehyde"],
            ALK4(t) = 8.4827, [unit = u"nmol/mol", description = ">= C4 alkanes"],
            AONITA(t) = 77.604, [unit = u"nmol/mol", description = "Aerosol-phase organic nitrate from aromatic precursors"],
            AROMRO2(t) = 77.132, [unit = u"nmol/mol", description = "generic peroxy radical from aromatic oxidation"],
            AROMP4(t) = 52.322, [unit = u"nmol/mol", description = "Generic C4 product from aromatic oxidation"],
            AROMP5(t) = 4.8975, [unit = u"nmol/mol", description = "Generic C5 product from aromatic oxidation"],
            ATO2(t) = 88.056, [unit = u"nmol/mol", description = "CH3C(O)CH2O2; RO2 from acetone"],
            ATOOH(t) = 95.672, [unit = u"nmol/mol", description = "CH3C(O)CH2OOH; ATO2 peroxide"],
            B3O2(t) = 44.692, [unit = u"nmol/mol", description = "CH3CH(OO)CH3; Secondary RO2 from C3H8"],
            BALD(t) = 35.859, [unit = u"nmol/mol", description = "benzaldehyde and tolualdehyde"],
            BENZ(t) = 18.166, [unit = u"nmol/mol", description = "C6H6; Benzene"],
            BENZO(t) = 92.094, [unit = u"nmol/mol", description = "C6H5O radical"],
            BENZO2(t) = 45.770, [unit = u"nmol/mol", description = "C6H5O2 radical"],
            BENZP(t) = 45.646, [unit = u"nmol/mol", description = "hydroperoxide from BENZO2"],
            Br(t) = 56.283, [unit = u"nmol/mol", description = "Br; Atomic bromine"],
            Br2(t) = 98.265, [unit = u"nmol/mol", description = "Br2; Molecular bromine"],
            BrCl(t) = 70.858, [unit = u"nmol/mol", description = "BrCl; Bromine chloride"],
            BrNO2(t) = 15.765, [unit = u"nmol/mol", description = "BrNO2; Nitryl bromide"],
            BrNO3(t) = 8.8808, [unit = u"nmol/mol", description = "BrNO3; Bromine nitrate"],
            BrO(t) = 90.871, [unit = u"nmol/mol", description = "BrO; Bromine monoxide"],
            BRO2(t) = 90.134, [unit = u"nmol/mol", description = "C6H5O2 ; Peroxy radical from BENZ oxidation"],
            BrSALA(t) = 5.6082, [unit = u"nmol/mol", description = "Br; Fine sea salt bromine"],
            BrSALC(t) = 23.602, [unit = u"nmol/mol", description = "Br; Course sea salt bromine"],
            BZCO3(t) = 34.301, [unit = u"nmol/mol", description = "benzoylperoxy radical"],
            BZCO3H(t) = 18.280, [unit = u"nmol/mol", description = "perbenzoic acid"],
            BZPAN(t) = 25.224, [unit = u"nmol/mol", description = "peroxybenzoyl nitrate"],
            C2H2(t) = 64.023, [unit = u"nmol/mol", description = "C2H2; Ethyne"],
            C2H4(t) = 48.832, [unit = u"nmol/mol", description = "Ethylene"],
            C2H6(t) = 95.500, [unit = u"nmol/mol", description = "C2H6; Ethane"],
            C3H8(t) = 93.457, [unit = u"nmol/mol", description = "C3H8; Propane"],
            C4HVP1(t) = 90.362, [unit = u"nmol/mol", description = "C4 hydroxy-vinyl-peroxy radicals from HPALDs"],
            C4HVP2(t) = 60.972, [unit = u"nmol/mol", description = "C4 hydroxy-vinyl-peroxy radicals from HPALDs"],
            CCl4(t) = 38.249, [unit = u"nmol/mol", description = "CCl4; Carbon tetrachloride"],
            CFC11(t) = 16.012, [unit = u"nmol/mol", description = "CCl3F ; CFC-11, R-11, Freon 11"],
            CFC12(t) = 60.683, [unit = u"nmol/mol", description = "CCl2F2; CFC-12, R-12, Freon 12"],
            CFC113(t) = 99.375, [unit = u"nmol/mol", description = "C2Cl3F3; CFC-113, Freon 113"],
            CFC114(t) = 82.883, [unit = u"nmol/mol", description = "C2Cl2F4; CFC-114, Freon 114"],
            CFC115(t) = 63.617, [unit = u"nmol/mol", description = "C2ClF5; CFC-115, Freon 115"],
            CH2Br2(t) = 53.658, [unit = u"nmol/mol", description = "CH3Br2; Dibromomethane"],
            CH2Cl2(t) = 6.5485, [unit = u"nmol/mol", description = "CH2Cl2; Dichloromethane"],
            CH2I2(t) = 62.463, [unit = u"nmol/mol", description = "CH2I2; Diiodomethane"],
            CH2IBr(t) = 98.965, [unit = u"nmol/mol", description = "CH2IBr; Bromoiodomethane"],
            CH2ICl(t) = 33.656, [unit = u"nmol/mol", description = "CH2ICl; Chloroiodomethane"],
            CH2O(t) = 34.136, [unit = u"nmol/mol", description = "CH2O; Formaldehyde"],
            CH2OO(t) = 72.666, [unit = u"nmol/mol", description = "CH2OO; Criegee intermediate"],
            CH3Br(t) = 76.768, [unit = u"nmol/mol", description = "CH3Br; Methyl bromide"],
            CH3CCl3(t) = 99.842, [unit = u"nmol/mol", description = "CH3CCl3; Methyl chloroform"],
            CH3CHOO(t) = 27.830, [unit = u"nmol/mol", description = "CH3CHOO; Criegee intermediate"],
            CH3Cl(t) = 14.055, [unit = u"nmol/mol", description = "CH3Cl; Chloromethane"],
            CH3I(t) = 19.671, [unit = u"nmol/mol", description = "CH3I; Methyl iodide"],
            CH4(t) = 6.9330, [unit = u"nmol/mol", description = "CH4; Methane"],
            CHBr3(t) = 84.204, [unit = u"nmol/mol", description = "CHBr3; Tribromethane"],
            CHCl3(t) = 79.435, [unit = u"nmol/mol", description = "CHCl3; Chloroform"],
            Cl(t) = 47.484, [unit = u"nmol/mol", description = "Cl; Atomic chlorine"],
            Cl2(t) = 71.292, [unit = u"nmol/mol", description = "Cl2; Molecular chlorine"],
            Cl2O2(t) = 96.248, [unit = u"nmol/mol", description = "Cl2O2; Dichlorine dioxide"],
            ClNO2(t) = 36.482, [unit = u"nmol/mol", description = "ClNO2; Nitryl chloride"],
            ClNO3(t) = 55.020, [unit = u"nmol/mol", description = "ClONO2; Chlorine nitrate"],
            ClO(t) = 0.9863, [unit = u"nmol/mol", description = "ClO; Chlorine monoxide"],
            ClOO(t) = 53.802, [unit = u"nmol/mol", description = "ClOO; Chlorine dioxide"],
            CO(t) = 32.978, [unit = u"nmol/mol", description = "CO; Carbon monoxide"],
            CO2(t) = 55.611, [unit = u"nmol/mol", description = "CO2; Carbon dioxide"],
            CSL(t) = 23.332, [unit = u"nmol/mol", description = "cresols and xylols"],
            DMS(t) = 5.8615, [unit = u"nmol/mol", description = "(CH3)2S; Dimethylsulfide"],
            EOH(t) = 18.988, [unit = u"nmol/mol", description = "C2H5OH; Ethanol"],
            ETHLN(t) = 69.851, [unit = u"nmol/mol", description = "CHOCH2ONO2; Ethanal nitrate"],
            ETHN(t) = 24.767, [unit = u"nmol/mol", description = "stable hydroxy-nitrooxy-ethane"],
            ETHP(t) = 59.843, [unit = u"nmol/mol", description = "stable hydroxy-hydroperoxy-ethane"],
            ETNO3(t) = 11.558, [unit = u"nmol/mol", description = "C2H5ONO2; Ethyl nitrate"],
            ETO(t) = 85.116, [unit = u"nmol/mol", description = "hydroxy-alkoxy-ethane radical"],
            ETOO(t) = 24.842, [unit = u"nmol/mol", description = "hydroxy-peroxy-ethane radical, formed from ethene + OH"],
            ETO2(t) = 29.300, [unit = u"nmol/mol", description = "CH3CH2OO; Ethylperoxy radical"],
            ETP(t) = 81.950, [unit = u"nmol/mol", description = "CH3CH2OOH; Ethylhydroperoxide"],
            GLYC(t) = 20.407, [unit = u"nmol/mol", description = "HOCH2CHO; Glycoaldehyde"],
            GLYX(t) = 81.571, [unit = u"nmol/mol", description = "CHOCHO; Glyoxal"],
            H(t) = 7.6410, [unit = u"nmol/mol", description = "H; Atomic hydrogen"],
            H1211(t) = 46.027, [unit = u"nmol/mol", description = "CBrClF2; H-1211"],
            H1301(t) = 36.584, [unit = u"nmol/mol", description = "CBrF3; H-1301"],
            H2402(t) = 52.639, [unit = u"nmol/mol", description = "C2Br2F4; H-2402"],
            H2O(t) = 56.623, [unit = u"nmol/mol", description = "H2O; Water vapor"],
            H2O2(t) = 44.325, [unit = u"nmol/mol", description = "H2O2; Hydrogen peroxide"],
            HAC(t) = 88.335, [unit = u"nmol/mol", description = "HOCH2C(O)CH3; Hydroxyacetone"],
            HBr(t) = 15.715, [unit = u"nmol/mol", description = "HBr; Hypobromic acid"],
            HC5A(t) = 44.638, [unit = u"nmol/mol", description = "C5H8O2; Isoprene-4,1-hydroxyaldehyde"],
            HCFC123(t) = 22.296, [unit = u"nmol/mol", description = "C2HCl2F3; HCFC-123, R-123, Freon 123"],
            HCFC141b(t) = 93.091, [unit = u"nmol/mol", description = "C(CH3)Cl2F; HCFC-141b, R-141b, Freon 141b"],
            HCFC142b(t) = 81.415, [unit = u"nmol/mol", description = "C(CH3)ClF2; HCFC-142b, R-142b, Freon 142b"],
            HCFC22(t) = 16.333, [unit = u"nmol/mol", description = "CHClF2 ; HCFC-22, R-22, Freon 22"],
            HCl(t) = 87.644, [unit = u"nmol/mol", description = "HCl; Hydrochloric acid"],
            HCOOH(t) = 99.489, [unit = u"nmol/mol", description = "HCOOH; Formic acid"],
            HI(t) = 68.377, [unit = u"nmol/mol", description = "HI; Hydrogen iodide"],
            HMHP(t) = 16.437, [unit = u"nmol/mol", description = "HOCH2OOH; Hydroxymethyl hydroperoxide"],
            HMML(t) = 33.654, [unit = u"nmol/mol", description = "C4H6O3; Hydroxymethyl-methyl-a-lactone"],
            HMS(t) = 54.099, [unit = u"nmol/mol", description = "HOCH2SO3-; hydroxymethanesulfonate"],
            HNO2(t) = 18.174, [unit = u"nmol/mol", description = "HONO; Nitrous acid"],
            HNO3(t) = 62.170, [unit = u"nmol/mol", description = "HNO3; Nitric acid"],
            HNO4(t) = 39.302, [unit = u"nmol/mol", description = "HNO4; Pernitric acid"],
            HO2(t) = 58.306, [unit = u"nmol/mol", description = "HO2; Hydroperoxyl radical"],
            HOBr(t) = 59.529, [unit = u"nmol/mol", description = "HOBr; Hypobromous acid"],
            HOCl(t) = 90.397, [unit = u"nmol/mol", description = "HOCl; Hypochlorous acid"],
            HOI(t) = 35.827, [unit = u"nmol/mol", description = "HOI; Hypoiodous acid"],
            HONIT(t) = 58.760, [unit = u"nmol/mol", description = "2nd gen monoterpene organic nitrate"],
            HPALD1(t) = 73.164, [unit = u"nmol/mol", description = "O=CHC(CH3)=CHCH2OOH; d-4,1-C5-hydroperoxyaldehyde"],
            HPALD1OO(t) = 34.759, [unit = u"nmol/mol", description = "peroxy radicals from HPALD1"],
            HPALD2(t) = 1.0291, [unit = u"nmol/mol", description = "HOOCH2C(CH3)=CHCH=O; d-1,4-C5-hydroperoxyaldehyde"],
            HPALD2OO(t) = 28.332, [unit = u"nmol/mol", description = "peroxy radicals from HPALD2"],
            HPALD3(t) = 91.404, [unit = u"nmol/mol", description = "O=CHC(CH3)OOHCH=CH2; b-2,1-C5-hydroperoxyaldehyde"],
            HPALD4(t) = 14.949, [unit = u"nmol/mol", description = "CH2=C(CH3)CHOOHCH=O; b-3,4-C5-hydroperoxyaldehyde"],
            HPETHNL(t) = 90.330, [unit = u"nmol/mol", description = "CHOCH2OOH; hydroperoxyethanal"],
            I(t) = 85.092, [unit = u"nmol/mol", description = "I; Atmoic iodine"],
            I2(t) = 49.639, [unit = u"nmol/mol", description = "I2; Molecular iodine"],
            I2O2(t) = 70.687, [unit = u"nmol/mol", description = "I2O2; Diiodine dioxide"],
            I2O3(t) = 85.950, [unit = u"nmol/mol", description = "I2O3; Diiodine trioxide"],
            I2O4(t) = 36.304, [unit = u"nmol/mol", description = "I2O4; Diiodine tetraoxide"],
            IBr(t) = 46.529, [unit = u"nmol/mol", description = "IBr; Iodine monobromide"],
            ICHE(t) = 17.739, [unit = u"nmol/mol", description = "C5H8O3; Isoprene hydroxy-carbonyl-epoxides"],
            ICHOO(t) = 75.448, [unit = u"nmol/mol", description = "peroxy radical from IEPOXD"],
            ICl(t) = 32.124, [unit = u"nmol/mol", description = "ICl; Iodine monochloride"],
            ICN(t) = 22.128, [unit = u"nmol/mol", description = "C5H7NO4; Lumped isoprene carbonyl nitrates"],
            ICNOO(t) = 12.649, [unit = u"nmol/mol", description = "peroxy radicals from ICN"],
            ICPDH(t) = 71.736, [unit = u"nmol/mol", description = "C5H10O5; Isoprene dihydroxy hydroperoxycarbonyl"],
            IDC(t) = 28.840, [unit = u"nmol/mol", description = "C5H6O2; Lumped isoprene dicarbonyls"],
            IDCHP(t) = 2.3035, [unit = u"nmol/mol", description = "C5H8O5; Isoprene dicarbonyl hydroxy dihydroperoxide"],
            IDHDP(t) = 21.649, [unit = u"nmol/mol", description = "C5H12O6; Isoprene dihydroxy dihydroperoxide"],
            IDHNBOO(t) = 25.086, [unit = u"nmol/mol", description = "peroxy radicals from INPB"],
            IDHNDOO1(t) = 15.276, [unit = u"nmol/mol", description = "peroxy radicals from INPD"],
            IDHNDOO2(t) = 61.961, [unit = u"nmol/mol", description = "peroxy radicals from INPD"],
            IDHPE(t) = 94.216, [unit = u"nmol/mol", description = "C5H10O5; Isoprene dihydroxy hydroperoxy epoxide"],
            IDN(t) = 13.328, [unit = u"nmol/mol", description = "C5H8N2O6; Lumped isoprene dinitrates"],
            IDNOO(t) = 44.188, [unit = u"nmol/mol", description = "peroxy radicals from IDN"],
            IEPOXA(t) = 60.554, [unit = u"nmol/mol", description = "C5H10O3; trans-Beta isoprene epoxydiol"],
            IEPOXAOO(t) = 27.948, [unit = u"nmol/mol", description = "peroxy radical from trans-Beta isoprene epoxydiol"],
            IEPOXB(t) = 38.609, [unit = u"nmol/mol", description = "C5H10O3; cis-Beta isoprene epoxydiol"],
            IEPOXBOO(t) = 87.094, [unit = u"nmol/mol", description = "peroxy radical from cis-Beta isoprene epoxydiol"],
            IEPOXD(t) = 8.0346, [unit = u"nmol/mol", description = "C5H10O3; Delta isoprene epoxydiol"],
            IHN1(t) = 11.028, [unit = u"nmol/mol", description = "C5H9NO4; Isoprene-d-4-hydroxy-1-nitrate"],
            IHN2(t) = 71.286, [unit = u"nmol/mol", description = "C5H9NO4; Isoprene-b-1-hydroxy-2-nitrate"],
            IHN3(t) = 82.443, [unit = u"nmol/mol", description = "C5H9NO4; Isoprene-b-4-hydroxy-3-nitrate"],
            IHN4(t) = 91.975, [unit = u"nmol/mol", description = "C5H9NO4; Isoprene-d-1-hydroxy-4-nitrate"],
            IHOO1(t) = 27.517, [unit = u"nmol/mol", description = "peroxy radical from OH addition to isoprene at C1"],
            IHOO4(t) = 51.624, [unit = u"nmol/mol", description = "peroxy radical from OH addition to isoprene at C4"],
            IHPNBOO(t) = 66.363, [unit = u"nmol/mol", description = "peroxy radicals from INPB"],
            IHPNDOO(t) = 63.447, [unit = u"nmol/mol", description = "peroxy radicals from INPD"],
            IHPOO1(t) = 79.476, [unit = u"nmol/mol", description = "peroxy radical from ISOPOOH"],
            IHPOO2(t) = 58.328, [unit = u"nmol/mol", description = "peroxy radical from ISOPOOH"],
            IHPOO3(t) = 5.9515, [unit = u"nmol/mol", description = "peroxy radical from ISOPOOH"],
            INA(t) = 26.490, [unit = u"nmol/mol", description = "alkoxy radical from INO2D"],
            INDIOL(t) = 52.424, [unit = u"nmol/mol", description = "Generic aerosol phase organonitrate hydrolysis product"],
            INO(t) = 73.106, [unit = u"nmol/mol", description = "INO; Nitrosyl iodide"],
            INO2B(t) = 25.723, [unit = u"nmol/mol", description = "beta-peroxy radicals from isoprene + NO3"],
            INO2D(t) = 30.524, [unit = u"nmol/mol", description = "delta-peroxy radicals from isoprene + NO3"],
            INPB(t) = 96.224, [unit = u"nmol/mol", description = "C5H9NO5; Lumped isoprene beta-hydroperoxy nitrates"],
            INPD(t) = 80.193, [unit = u"nmol/mol", description = "C5H9NO5; Lumped isoprene delta-hydroperoxy nitrates"],
            IO(t) = 26.615, [unit = u"nmol/mol", description = "IO; Iodine monoxide"],
            IONITA(t) = 25.539, [unit = u"nmol/mol", description = "Aerosol-phase organic nitrate from isoprene precursors"],
            IONO(t) = 56.756, [unit = u"nmol/mol", description = "IONO; Nitryl iodide"],
            IONO2(t) = 53.992, [unit = u"nmol/mol", description = "IONO2; Iodine nitrate"],
            IPRNO3(t) = 22.638, [unit = u"nmol/mol", description = "C3H8ONO2; Isopropyl nitrate"],
            ...
            ISOP(t) = 83.240, [unit = u"nmol/mol", description = "CH2=C(CH3)CH=CH2; Isoprene"],
            ISOPNOO1(t) = 60.043, [unit = u"nmol/mol", description = "peroxy radicals from IHN2"],
            ISOPNOO2(t) = 71.160, [unit = u"nmol/mol", description = "peroxy radicals from IHN3"],
            ITCN(t) = 26.206, [unit = u"nmol/mol", description = "C5H9NO7; Lumped tetrafunctional isoprene carbonyl-nitrates"],
            ITHN(t) = 11.572, [unit = u"nmol/mol", description = "C5H11NO7; Lumped tetrafunctional isoprene hydroxynitrates"],
            KO2(t) = 84.868, [unit = u"nmol/mol", description = "RO2 from >3 ketones"],
            LBRO2H(t) = 61.633, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of BRO2 by HO2"],
            LBRO2N(t) = 11.255, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of BRO2 by NO"],
            LIMO(t) = 53.446, [unit = u"nmol/mol", description = "C10H16; Limonene"],
            LIMO2(t) = 92.794, [unit = u"nmol/mol", description = "RO2 from LIMO"],
            LISOPOH(t) = 92.199, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of ISOP by OH"],
            LISOPNO3(t) = 29.918, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of ISOP by NO3"],
            LNRO2H(t) = 29.939, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of NRO2 by HO2"],
            LNRO2N(t) = 57.661, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of NRO2 by NO"],
            LTRO2H(t) = 46.441, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of TRO2 by HO2"],
            LTRO2N(t) = 28.826, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of TRO2 by NO"],
            LVOC(t) = 47.079, [unit = u"nmol/mol", description = "C5H14O5; Gas-phase low-volatility non-IEPOX product of ISOPOOH (RIP) oxidation"],
            LVOCOA(t) = 97.788, [unit = u"nmol/mol", description = "C5H14O5; Aerosol-phase low-volatility non-IEPOX product of ISOPOOH (RIP) oxidation"],
            LXRO2H(t) = 62.462, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of XRO2 by HO2"],
            LXRO2N(t) = 39.337, [unit = u"nmol/mol", description = "Dummy spc to track oxidation of XRO2 by NO"],
            MACR(t) = 17.935, [unit = u"nmol/mol", description = "CH2=C(CH3)CHO; Methacrolein"],
            MACR1OO(t) = 91.114, [unit = u"nmol/mol", description = "peroxyacyl radical from MACR + OH"],
            MACR1OOH(t) = 61.547, [unit = u"nmol/mol", description = "CH2=C(CH3)C(O)OOH; Peracid from MACR"],
            MACRNO2(t) = 97.585, [unit = u"nmol/mol", description = "Product of MCRHN + OH"],
            MAP(t) = 61.421, [unit = u"nmol/mol", description = "CH3C(O)OOH; Peroxyacetic acid"],
            MCO3(t) = 0.6220, [unit = u"nmol/mol", description = "CH3C(O)OO; Peroxyacetyl radical"],
            MCRDH(t) = 23.756, [unit = u"nmol/mol", description = "C4H8O3; Dihydroxy-MACR"],
            MCRENOL(t) = 43.151, [unit = u"nmol/mol", description = "C4H6O2; Lumped enols from MVK/MACR"],
            MCRHN(t) = 5.5067, [unit = u"nmol/mol", description = "HOCH2C(ONO2)(CH3)CHO; Hydroxynitrate from MACR"],
            MCRHNB(t) = 2.8277, [unit = u"nmol/mol", description = "O2NOCH2C(OH)(CH3)CHO; Hydroxynitrate from MACR"],
            MCRHP(t) = 0.2048, [unit = u"nmol/mol", description = "HOCH2C(OOH)(CH3)CHO; Hydroxy-hydroperoxy-MACR"],
            MCROHOO(t) = 49.422, [unit = u"nmol/mol", description = "peroxy radical from MACR + OH"],
            MCT(t) = 77.753, [unit = u"nmol/mol", description = "methylcatechols"],
            MEK(t) = 61.732, [unit = u"nmol/mol", description = "RC(O)R; Methyl ethyl ketone"],
            MENO3(t) = 89.773, [unit = u"nmol/mol", description = "CH3ONO2; methyl nitrate"],
            MGLY(t) = 93.209, [unit = u"nmol/mol", description = "CH3COCHO; Methylglyoxal"],
            MO2(t) = 73.881, [unit = u"nmol/mol", description = "CH3O2; Methylperoxy radical"],
            MOH(t) = 55.585, [unit = u"nmol/mol", description = "CH3OH; Methanol"],
            MONITA(t) = 61.052, [unit = u"nmol/mol", description = "Aerosol-phase organic nitrate from monoterpene precursors"],
            MONITS(t) = 71.179, [unit = u"nmol/mol", description = "Saturated 1st gen monoterpene organic nitrate"],
            MONITU(t) = 23.294, [unit = u"nmol/mol", description = "Unsaturated 1st gen monoterpene organic nitrate"],
            MP(t) = 25.386, [unit = u"nmol/mol", description = "CH3OOH; Methylhydroperoxide"],
            MPAN(t) = 89.575, [unit = u"nmol/mol", description = "CH2=C(CH3)C(O)OONO2; Peroxymethacroyl nitrate (PMN)"],
            MPN(t) = 59.399, [unit = u"nmol/mol", description = "CH3O2NO2; Methyl peroxy nitrate"],
            MSA(t) = 82.711, [unit = u"nmol/mol", description = "CH4SO3; Methanesulfonic acid"],
            MTPA(t) = 25.413, [unit = u"nmol/mol", description = "Lumped monoterpenes: a-pinene, b-pinene, sabinene, carene"],
            MTPO(t) = 8.9141, [unit = u"nmol/mol", description = "Other monoterpenes: Terpinene, terpinolene, myrcene, ocimene, other monoterpenes"],
            MVK(t) = 62.109, [unit = u"nmol/mol", description = "CH2=CHC(=O)CH3; Methyl vinyl ketone"],
            MVKDH(t) = 97.635, [unit = u"nmol/mol", description = "HOCH2CH2OHC(O)CH3; Dihydroxy-MVK"],
            MVKHC(t) = 98.159, [unit = u"nmol/mol", description = "C4H6O3; MVK hydroxy-carbonyl"],
            MVKHCB(t) = 50.621, [unit = u"nmol/mol", description = "C4H6O3; MVK hydroxy-carbonyl"],
            MVKHP(t) = 35.334, [unit = u"nmol/mol", description = "C4H8O4; MVK hydroxy-hydroperoxide"],
            MVKN(t) = 48.570, [unit = u"nmol/mol", description = "HOCH2CH(ONO2)C(=O)CH3; Hydroxynitrate from MVK"],
            MVKOHOO(t) = 41.490, [unit = u"nmol/mol", description = "peroxy radical from MVK + OH"],
            MVKPC(t) = 8.2590, [unit = u"nmol/mol", description = "OCHCH(OOH)C(O)CH3; MVK hydroperoxy-carbonyl"],
            N(t) = 56.891, [unit = u"nmol/mol", description = "N; Atomic nitrogen"],
            N2O(t) = 50.751, [unit = u"nmol/mol", description = "N2O; Nitrous oxide"],
            N2O5(t) = 19.118, [unit = u"nmol/mol", description = "N2O5; Dinitrogen pentoxide"],
            NAP(t) = 33.270, [unit = u"nmol/mol", description = "C10H8; Naphthalene; IVOC surrogate"],
            NIT(t) = 77.088, [unit = u"nmol/mol", description = "NIT; Fine mode inorganic nitrate"],
            NITs(t) = 56.341, [unit = u"nmol/mol", description = "NITs; Coarse mode inorganic nitrate"],
            NO(t) = 54.454, [unit = u"nmol/mol", description = "NO; Nitric oxide"],
            NO2(t) = 5.5605, [unit = u"nmol/mol", description = "NO2; Nitrogen dioxide"],
            NO3(t) = 31.739, [unit = u"nmol/mol", description = "NO3; Nitrate radical"],
            NPHEN(t) = 87.002, [unit = u"nmol/mol", description = "nitrophenols"],
            NPRNO3(t) = 58.488, [unit = u"nmol/mol", description = "C3H8ONO2; n-propyl nitrate"],
            NRO2(t) = 83.618, [unit = u"nmol/mol", description = "Peroxy radical from NAP oxidation"],
            O(t) = 14.164, [unit = u"nmol/mol", description = "O(3P); Ground state atomic oxygen"],
            O1D(t) = 17.648, [unit = u"nmol/mol", description = "O(1D); Excited atomic oxygen"],
            O3(t) = 2.1326, [unit = u"nmol/mol", description = "O3; Ozone"],
            O3A(t) = 28.223, [unit = u"nmol/mol", description = "O3; Ozone in accum seasalt"],
            O3C(t) = 49.728, [unit = u"nmol/mol", description = "O3; Ozone in coarse seasalt"],
            OClO(t) = 60.037, [unit = u"nmol/mol", description = "OClO; Chlorine dioxide"],
            OCS(t) = 20.867, [unit = u"nmol/mol", description = "COS; Carbonyl sulfide"],
            OH(t) = 19.293, [unit = u"nmol/mol", description = "OH; Hydroxyl radical"],
            OIO(t) = 51.406, [unit = u"nmol/mol", description = "OIO; Iodine dioxide"],
            OLND(t) = 63.247, [unit = u"nmol/mol", description = "Monoterpene-derived NO3-alkene adduct"],
            OLNN(t) = 95.667, [unit = u"nmol/mol", description = "Monoterpene-derived NO3 adduct"],
            OTHRO2(t) = 74.722, [unit = u"nmol/mol", description = "Other C2 RO2 not from C2H6 oxidation"],
            PAN(t) = 59.945, [unit = u"nmol/mol", description = "CH3C(O)OONO2; Peroxyacetylnitrate"],
            PHEN(t) = 59.463, [unit = u"nmol/mol", description = "phenol"],
            PIO2(t) = 94.953, [unit = u"nmol/mol", description = "RO2 from MTPA"],
            PIP(t) = 96.809, [unit = u"nmol/mol", description = "Peroxides from MTPA"],
            PO2(t) = 25.827, [unit = u"nmol/mol", description = "HOCH2CH(OO)CH3; RO2 from propene"],
            PP(t) = 61.804, [unit = u"nmol/mol", description = "HOCH2CH(OOH)CH3; Peroxide from PO2"],
            PPN(t) = 94.436, [unit = u"nmol/mol", description = "CH3CH2C(O)OONO2; Peroxypropionylnitrate"],
            PRN1(t) = 87.618, [unit = u"nmol/mol", description = "O2NOCH2CH(OO)CH3; RO2 from propene + NO3"],
            PROPNN(t) = 33.842, [unit = u"nmol/mol", description = "CH3C(=O)CH2ONO2; Propanone nitrate"],
            PRPE(t) = 63.131, [unit = u"nmol/mol", description = "C3H6; >= C3 alkenes"],
            PRPN(t) = 43.083, [unit = u"nmol/mol", description = "O2NOCH2CH(OOH)CH3; Peroxide from PRN1"],
            PYAC(t) = 79.104, [unit = u"nmol/mol", description = "CH3COCOOH; Pyruvic acid"],
            R4N1(t) = 37.438, [unit = u"nmol/mol", description = "RO2 from R4N2"],
            R4N2(t) = 46.153, [unit = u"nmol/mol", description = "RO2NO; >= C4 alkylnitrates"],
            R4O2(t) = 36.162, [unit = u"nmol/mol", description = "RO2 from ALK4"],
            R4P(t) = 40.804, [unit = u"nmol/mol", description = "CH3CH2CH2CH2OOH; Peroxide from R4O2"],
            RA3P(t) = 57.025, [unit = u"nmol/mol", description = "CH3CH2CH2OOH; Peroxide from A3O2"],
            RB3P(t) = 72.421, [unit = u"nmol/mol", description = "CH3CH(OOH)CH3; Peroxide from B3O2"],
            RCHO(t) = 37.680, [unit = u"nmol/mol", description = "CH3CH2CHO; >= C3 aldehydes"],
            RCO3(t) = 63.108, [unit = u"nmol/mol", description = "CH3CH2C(O)OO; Peroxypropionyl radical"],
            RIPA(t) = 42.881, [unit = u"nmol/mol", description = "HOCH2C(OOH)(CH3)CH=CH2; 1,2-ISOPOOH"],
            RIPB(t) = 24.737, [unit = u"nmol/mol", description = "HOCH2C(OOH)(CH3)CH=CH2; 4,3-ISOPOOH"],
            RIPC(t) = 57.374, [unit = u"nmol/mol", description = "C5H10O3; d(1,4)-ISOPOOH"],
            RIPD(t) = 5.9941, [unit = u"nmol/mol", description = "C5H10O3; d(4,1)-ISOPOOH"],
            ROH(t) = 67.750, [unit = u"nmol/mol", description = "C3H7OH; > C2 alcohols"],
            RP(t) = 38.598, [unit = u"nmol/mol", description = "CH3CH2C(O)OOH; Peroxide from RCO3"],
            SALAAL(t) = 37.928, [unit = u"nmol/mol", description = "Accumulation mode seasalt aerosol alkalinity"],
            SALCAL(t) = 13.651, [unit = u"nmol/mol", description = "Coarse mode seasalt aerosol alkalinity"],
            SALACL(t) = 41.613, [unit = u"nmol/mol", description = "Cl; Fine chloride"],
            SALCCL(t) = 41.813, [unit = u"nmol/mol", description = "Cl; Coarse chloride"],
            SALASO2(t) = 46.971, [unit = u"nmol/mol", description = "SO2; Fine seasalt"],
            SALCSO2(t) = 98.028, [unit = u"nmol/mol", description = "SO2; Coarse seasalt"],
            SALASO3(t) = 18.107, [unit = u"nmol/mol", description = "SO3--; Fine seasalt"],
            SALCSO3(t) = 51.008, [unit = u"nmol/mol", description = "SO3--; Coarse chloride"],
            SO2(t) = 6.2180, [unit = u"nmol/mol", description = "SO2; Sulfur dioxide"],
            SO4(t) = 97.494, [unit = u"nmol/mol", description = "SO4; Sulfate"],
            SO4s(t) = 74.244, [unit = u"nmol/mol", description = "SO4 on sea-salt; Sulfate"],
            SOAGX(t) = 82.469, [unit = u"nmol/mol", description = "CHOCHO; Aerosol-phase glyoxal"],
            SOAIE(t) = 81.289, [unit = u"nmol/mol", description = "C5H10O3; Aerosol-phase IEPOX"],
            TOLU(t) = 58.265, [unit = u"nmol/mol", description = "C7H8; Toluene"],
            TRO2(t) = 10.659, [unit = u"nmol/mol", description = "Peroxy radical from TOLU oxidation"],
            XYLE(t) = 24.563, [unit = u"nmol/mol", description = "C8H10; Xylene"],
            XRO2(t) = 25.058, [unit = u"nmol/mol", description = "Peroxy radical from XYLE oxidation"],
            H2(t) = 97.924, [unit = u"nmol/mol", description = "H2; Molecular hydrogen"],
            N2(t) = 36.998, [unit = u"nmol/mol", description = "N2; Molecular nitrogen"],
            O2(t) = 51.201, [unit = u"nmol/mol", description = "O2; Molecular oxygen"],
            RCOOH(t) = 12.892, [unit = u"nmol/mol", description = "C2H5C(O)OH; > C2 organic acids "],
        )
        ...
        @parameters(
            ...
            k_mt5 = 0, [unit = u"mol/nmol", description = "Seasalt rate constant"],
            k_mt6 = 0, [unit = u"mol/nmol", description = "Seasalt rate constant"],
            k_cld1 = 0, [unit = u"mol/nmol", description = "Cloud rate constant"],
            k_cld2 = 0, [unit = u"mol/nmol", description = "Cloud rate constant"],
            k_cld3 = 0, [description = "Cloud rate constant (dimensionless)"],
            k_cld4 = 0, [unit = u"mol/nmol", description = "HMS rate constant"],
            k_cld5 = 0, [description = "HMS rate constant (dimensionless)"],
            k_cld6 = 0, [unit = u"mol/nmol", description = "HMS rate constant"],
