...
function GEOSChemGasPhase(; name = :GEOSChemGasPhase, rxn_sys = false)
    ...
    rx_sys = @reaction_network GEOSChemGasPhase begin
        ...
        @parameters(T=298.15,
            ...
            num_density=2.7e19,
            [
                description="Number density of air (The units should be molecules/cm^3 but the equations here treat it as unitless).",
            ],
            k_mt1=0,
            [
                unit=u"ppb^-1*s^-1",
        ...
        tbrnch(t, T, 9.50e-14, 0, 390.0e0, 2.62e1, 0, -1130.0e0),
        MO2 + MO2 --> MOH + CH2O + O2
        tbrnch(t, T, 9.50e-14, 0, 390.0e0, 4.0e-2, 0, 1130.0e0),
        ...
        arrsq(t, T, 2.88e-35, 0.0, 1391.0e0),
        ...
        rISO1(t, T, 1.7e-11, 3.90e2, 9.33e-2, 5.05e15, -1.22e4, 1.79e14, -8.830e3),
        ISOP + OH --> LISOPOH + IHOO1#==2019/11/06; Bates2019; KHB==#
        rISO1(t, T, 1.0e-11, 3.90e2, 2.26e-1, 2.22e9, -7.160e3, 1.75e14, -9.054e3),
        ISOP + OH --> LISOPOH + IHOO4#==2019/11/06; Bates2019; KHB==#
        rISO2(t, T, 1.7e-11, 3.90e2, 9.33e-2, 5.05e15, -1.22e4, 1.79e14, -8.830e3),
        ISOP + OH -->
        0.3MCO3 +
        0.3MGLY +
        0.3CH2O +
        ...
        rISO2(t, T, 1.0e-11, 3.90e2, 2.26e-1, 2.22e9, -7.160e3, 1.75e14, -9.054e3),
        ISOP + OH -->
        0.3CH2O +
        0.15HPALD4 +
        0.25HPALD2 +
        ...
        0.3ATOOH +
        LISOPOH#==2019/11/06; Bates2019; KHB==#
        arrpls(t, T, 2.12e-13, -1300e0, 0, 1.1644e0, -7.0485e-4),
        ...
        arrpls(t, T, 2.12e-13, -1300e0, 0, 1.2038e0, -9.0435e-4),
        ...
        arr(t, T, 4.70e-13, 0.0e0, 1220.0e0),
        ...
        arr(t, T, 1.10e-11, 0.0e0, 340.0e0),
