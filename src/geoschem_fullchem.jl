...
function GEOSChemGasPhase(; name = :GEOSChemGasPhase, rxn_sys = false)
    ...
    rx_sys = @network_component GEOSChemGasPhase begin
        ...
        #BrSALC(t) = 23.602, [unit = u"ppb", description = "Br; Course sea salt bromine"],
            ...
            [
            unit=u"ppb",
            description="hydroxy-peroxy-ethane radical, formed from ethene + OH"
        ],
            ETO2(t)=29.300,
            ...
            [
            unit=u"ppb",
            description="O=CHC(CH3)=CHCH2OOH; d-4,1-C5-hydroperoxyaldehyde"
        ],
            HPALD1OO(t)=34.759,
            ...
            [
            unit=u"ppb",
            description="HOOCH2C(CH3)=CHCH=O; d-1,4-C5-hydroperoxyaldehyde"
        ],
            HPALD2OO(t)=28.332,
            ...
            [
            unit=u"ppb",
            description="O=CHC(CH3)OOHCH=CH2; b-2,1-C5-hydroperoxyaldehyde"
        ],
            HPALD4(t)=14.949,
            [
            unit=u"ppb",
            description="CH2=C(CH3)CHOOHCH=O; b-3,4-C5-hydroperoxyaldehyde"
        ],
            HPETHNL(t)=90.330,
            [unit=u"ppb", description="CHOCH2OOH; hydroperoxyethanal"],
            I(t)=85.092,
            [unit=u"ppb", description="I; Atmoic iodine"],
            I2(t)=49.639,
            ...
            [
            unit=u"ppb",
            description="C5H10O5; Isoprene dihydroxy hydroperoxycarbonyl"
        ],
            IDC(t)=28.840,
            ...
            [
            unit=u"ppb",
            description="C5H8O5; Isoprene dicarbonyl hydroxy dihydroperoxide"
        ],
            IDHDP(t)=21.649,
            ...
            [
            unit=u"ppb",
            description="C5H10O5; Isoprene dihydroxy hydroperoxy epoxide"
        ],
            IDN(t)=13.328,
            ...
            [
            unit=u"ppb",
            description="peroxy radical from trans-Beta isoprene epoxydiol"
        ],
            IEPOXB(t)=38.609,
            ...
            [
            unit=u"ppb",
            description="peroxy radical from cis-Beta isoprene epoxydiol"
        ],
            IEPOXD(t)=8.0346,
            ...
            [
            unit=u"ppb",
            description="peroxy radical from OH addition to isoprene at C1"
        ],
            IHOO4(t)=51.624,
            [
            unit=u"ppb",
            description="peroxy radical from OH addition to isoprene at C4"
        ],
            IHPNBOO(t)=66.363,
            [unit=u"ppb", description="peroxy radicals from INPB"],
            IHPNDOO(t)=63.447,
            ...
            [
            unit=u"ppb",
            description="Generic aerosol phase organonitrate hydrolysis product"
        ],
            INO(t)=73.106,
            ...
            [
            unit=u"ppb",
            description="C5H9NO5; Lumped isoprene beta-hydroperoxy nitrates"
        ],
            INPD(t)=80.193,
            [
            unit=u"ppb",
            description="C5H9NO5; Lumped isoprene delta-hydroperoxy nitrates"
        ],
            IO(t)=26.615,
            ...
            [
            unit=u"ppb",
            description="Aerosol-phase organic nitrate from isoprene precursors"
        ],
            IONO(t)=56.756,
        ...
        #ISALC(t) = 13.184, [unit = u"ppb", description = "I; Coarse sea salt iodine"],
            ...
            [
            unit=u"ppb",
            description="C5H9NO7; Lumped tetrafunctional isoprene carbonyl-nitrates"
        ],
            ITHN(t)=11.572,
            [
            unit=u"ppb",
            description="C5H11NO7; Lumped tetrafunctional isoprene hydroxynitrates"
        ],
            KO2(t)=84.868,
        ...
        #LVOCOA(t) = 97.788, [unit = u"ppb", description = "C5H14O5; Aerosol-phase low-volatility non-IEPOX product of ISOPOOH (RIP) oxidation"],
            ...
            [
            unit=u"ppb",
            description="Aerosol-phase organic nitrate from monoterpene precursors"
        ],
            MONITS(t)=71.179,
            ...
            [
            unit=u"ppb",
            description="Unsaturated 1st gen monoterpene organic nitrate"
        ],
            MP(t)=25.386,
            ...
            [
            unit=u"ppb",
            description="CH2=C(CH3)C(O)OONO2; Peroxymethacroyl nitrate (PMN)"
        ],
            MPN(t)=59.399,
            ...
            [
            unit=u"ppb",
            description="Lumped monoterpenes: a-pinene, b-pinene, sabinene, carene"
        ],
            MTPO(t)=8.9141,
            [
            unit=u"ppb",
        ...
        #SOAIE(t) = 81.289, [unit = u"ppb", description = "C5H10O3; Aerosol-phase IEPOX"],
            ...
            H2(t)=97.924,
            [unit=u"ppb", description="H2; Molecular hydrogen"],
            N2(t)=36.998,
            [unit=u"ppb", description="N2; Molecular nitrogen"],
            O2(t)=51.201,
            [unit=u"ppb", description="O2; Molecular oxygen"],
            RCOOH(t)=12.892,
        ...
        # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        arr(t, T, num_density, 3.00e-12, 0.0, -1500.0e0), O3 + NO --> NO2 + O2
        arr(t, T, num_density, 1.70e-12, 0.0, -940.0e0), O3 + OH --> HO2 + O2
        arr(t, T, num_density, 1.00e-14, 0.0, -490.0e0), O3 + HO2 --> OH + O2 + O2
        arr(t, T, num_density, 1.20e-13, 0.0, -2450.0e0), O3 + NO2 --> O2 + NO3
        arr(t, T, num_density, 2.90e-16, 0.0, -1000.0e0), O3 + MO2 --> CH2O + HO2 + O2#==2014/02/03; Eastham2014; SDE==#
        c(1.80e-12, T, num_density), OH + OH --> H2O + O#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 6.90e-31, 1.0e+00, 0.0, 2.6e-11, 0.0, 0.0, 0.6e0),
        OH + OH --> H2O2#==+M==#
        arr(t, T, num_density, 4.80e-11, 0.0, 250.0e0), OH + HO2 --> H2O + O2
        c(1.80e-12, T, num_density), OH + H2O2 --> H2O + HO2
        arr(t, T, num_density, 3.30e-12, 0.0, 270.0e0), HO2 + NO --> OH + NO2#==2013/02/12; JPL 10-6; BHH,JMAO,EAM==#
        rHO2HO2(t, T, num_density, H2O, 3.00e-13, 460.0e0, 2.1e-33, 920.0e0),
        ...
        rRO2NOb1(t, T, num_density, 2.80e-12, 300.0e0), MO2 + NO --> CH2O + HO2 + NO2#==2019/05/10; Fisher2018; JAF==#
        rRO2NOa1(t, T, num_density, 2.80e-12, 300.0e0), MO2 + NO --> MENO3#==2019/05/10; Fisher2018; JAF==#
        arr(t, T, num_density, 4.10e-13, 0.0e0, 750.0e0), MO2 + HO2 --> MP + O2
        tbrnch(t, T, num_density, 9.50e-14, 0, 390.0e0, 2.62e1, 0, -1130.0e0),
        MO2 + MO2 --> MOH + CH2O + O2
        tbrnch(t, T, num_density, 9.50e-14, 0, 390.0e0, 4.0e-2, 0, 1130.0e0),
        MO2 + MO2 --> 2.000CH2O + 2.000HO2
        c(1.60e-10, T, num_density), MO2 + OH --> 0.13MOH + 0.87CH2O + 1.74HO2#==2021/09/22; Bates2021a; KHB,MSL==#
        ...
        arr(t, T, num_density, 5.50e-12, 0.0, 125.0e0), CH2O + OH --> CO + HO2 + H2O
        arr3(t, T, num_density, 1.80e-30, 3.0e+00, 0.0, 2.8e-11, 0.0, 0.0, 0.6e0),
        NO2 + OH --> HNO3#==+M==#
        rOHHNO3(
            t,
            T,
        ...
        HNO3 + OH --> H2O + NO3
        arr3(t, T, num_density, 7.00e-31, 2.6e+00, 0.0, 3.60e-11, 0.1e0, 0.0, 0.6e0),
        NO + OH --> HNO2#==+M==#
        arr(t, T, num_density, 1.80e-11, 0.0, -390.0e0), HNO2 + OH --> H2O + NO2
        arr3(t, T, num_density, 1.90e-31, 3.4e+00, 0.0, 4.0e-12, 0.3e0, 0.0, 0.6e0),
        ...
        arr(t, T, num_density, 1.30e-12, 0.0, 380.0e0), HNO4 + OH --> H2O + NO2 + O2
        c(3.50e-12, T, num_density), HO2 + NO3 --> OH + NO2 + O2
        arr(t, T, num_density, 1.50e-11, 0.0, 170.0e0), NO + NO3 --> 2.000NO2
        c(2.20e-11, T, num_density), OH + NO3 --> HO2 + NO2
        arr3(t, T, num_density, 2.40e-30, 3.0e+00, 0.0, 1.6e-12, -0.1e0, 0.0, 0.6e0),
        ...
        c(4.00e-13, T, num_density), HCOOH + OH --> H2O + CO2 + HO2#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        arr(t, T, num_density, 2.90e-12, 0.0, -345.0e0), MOH + OH --> HO2 + CH2O
        arr(t, T, num_density, 4.50e-14, 0.0, -1260.0e0), NO2 + NO3 --> NO + NO2 + O2
        c(5.80e-16, T, num_density), NO3 + CH2O --> HNO3 + HO2 + CO
        arr(t, T, num_density, 4.63e-12, 0.0, 350.0e0),
        ALD2 + OH --> 0.950MCO3 + 0.050CH2O + 0.050CO + 0.050HO2 + H2O#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.40e-12, 0.0, -1900.0e0), ALD2 + NO3 --> HNO3 + MCO3
        arr3(t, T, num_density, 9.70e-29, 5.6e+00, 0.0, 9.3e-12, 1.5e0, 0.0, 0.6e0),
        ...
        PAN --> MCO3 + NO2
        arr(t, T, num_density, 8.10e-12, 0.0, 270.0e0), MCO3 + NO --> MO2 + NO2 + CO2
        arr(t, T, num_density, 7.66e-12, 0.0, -1020.0e0), C2H6 + OH --> ETO2 + H2O#==2013/02/12; JPL 10-6; BHH,JMAO,EAM==#
        rRO2NOb2(t, T, num_density, 2.60e-12, 365.0e0, 2.0e0),
        ...
        arr(t, T, num_density, 2.70e-12, 0.0, 350.0e0), PO2 + NO --> NO2 + HO2 + CH2O + ALD2
        arr(t, T, num_density, 9.10e-12, 0.0, -405.0e0), ALK4 + OH --> R4O2
        rRO2NOb2(t, T, num_density, 2.70e-12, 350.0e0, 4.5e0),
        R4O2 + NO -->
        NO2 +
        0.320ACET +
        0.190MEK +
        ...
        0.050A3O2 +
        0.180B3O2 +
        0.320OTHRO2#==2017/02/23; ALK4 lumping fix; BHH==#
        rRO2NOa2(t, T, num_density, 2.70e-12, 350.0e0, 4.5e0), R4O2 + NO --> R4N2
        arr(t, T, num_density, 2.70e-12, 0.0, 350.0e0),
        R4N1 + NO --> 2.000NO2 + 0.570RCHO + 0.860ALD2 + 0.570CH2O#==2017/07/27; Fix C creation; SAS,BHH,MJE==#
        arr(t, T, num_density, 2.80e-12, 0.0, 300.0e0), ATO2 + NO --> NO2 + CH2O + MCO3#==2017/07/27; Fix C creation; SAS,BHH,MJE==#
        arr(t, T, num_density, 2.70e-12, 0.0, 350.0e0),
        KO2 + NO --> 0.930NO2 + 0.930ALD2 + 0.930MCO3 + 0.070R4N2
        rRO2NOa2(t, T, num_density, 2.70e-12, 360.0e0, 3.0e0),
        ...
        arr(t, T, num_density, 2.70e-12, 0.0, 350.0e0), PRN1 + NO --> 2.000NO2 + CH2O + ALD2
        arr(t, T, num_density, 2.80e-12, 0.0, -3280.0e0), ALK4 + NO3 --> HNO3 + R4O2
        c(1.60e-12, T, num_density), R4N2 + OH --> R4N1 + H2O
        arr(t, T, num_density, 3.15e-14, 0.0, 920.0e0), ACTA + OH --> MO2 + CO2 + H2O#==2013/02/12; JPL 10-6; BHH,JMAO,EAM==#
        arr(t, T, num_density, 6.00e-12, 0.0, 410.0e0), OH + RCHO --> RCO3 + H2O
        arr3(t, T, num_density, 9.00e-28, 8.9e0, 0.0, 7.7e-12, 0.2e0, 0.0, 0.6e0),
        ...
        PPN --> RCO3 + NO2
        arr(t, T, num_density, 6.70e-12, 0.0, 340.0e0),
        ...
        arr(t, T, num_density, 7.40e-13, 0.0, 700.0e0), R4O2 + HO2 --> R4P
        arr(t, T, num_density, 7.40e-13, 0.0, 700.0e0), R4N1 + HO2 --> R4N2
        arr(t, T, num_density, 8.60e-13, 0.0, 700.0e0),
        ATO2 + HO2 --> 0.150MCO3 + 0.150OH + 0.150CH2O + 0.850ATOOH#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        rRO2HO2(t, T, num_density, 2.91e-13, 1300.0e0, 4.0e0),
        KO2 + HO2 --> 0.150OH + 0.150ALD2 + 0.150MCO3 + 0.850ATOOH#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        ...
        0.250ROH +
        0.500HO2
        arr(t, T, num_density, 7.50e-13, 0.0, 500.0e0),
        ATO2 + MO2 -->
        0.300HO2 + 0.300CH2O + 0.300MCO3 + 0.200HAC + 0.200CH2O + 0.500MGLY + 0.500MOH
        c(8.37e-14, T, num_density),
        KO2 + MO2 -->
        0.500ALD2 + 0.500MCO3 + 0.250MEK + 0.750CH2O + 0.250MOH + 0.250ROH + 0.500HO2
        c(8.37e-14, T, num_density),
        B3O2 + MO2 -->
        0.500HO2 + 0.500ACET + 0.250ACET + 0.750CH2O + 0.250MOH + 0.250ROH + 0.500HO2
        c(8.37e-14, T, num_density),
        PRN1 + MO2 -->
        NO2 +
        0.500CH2O +
        ...
        arr(t, T, num_density, 4.60e-12, 0.0, 70.0e0), ROH + OH --> HO2 + RCHO
        c(4.10e-14, T, num_density), ETO2 + ETO2 --> 2.000ALD2 + 2.000HO2
        c(4.10e-14, T, num_density), OTHRO2 + OTHRO2 --> 2.000ALD2 + 2.000HO2#==2019/05/10; Fisher2018; JAF==#
        c(2.70e-14, T, num_density), ETO2 + ETO2 --> EOH + ALD2
        c(2.70e-14, T, num_density), OTHRO2 + OTHRO2 --> EOH + ALD2#==2019/05/10; Fisher2018; JAF==#
        arr(t, T, num_density, 7.40e-13, 0.0, 700.0e0), HO2 + ETO2 --> ETP
        arr(t, T, num_density, 7.40e-13, 0.0, 700.0e0), HO2 + OTHRO2 --> ETP#==2019/05/10; Fisher2018; JAF==#
        ...
        arr(t, T, num_density, 4.30e-13, 0.0, 1040.0e0),
        RCO3 + HO2 -->
        0.410RP + 0.150RCOOH + 0.150O3 + 0.440OH + 0.220OTHRO2 + 0.030A3O2 + 0.120B3O2#==2019/05/10; Fisher2018; JAF==#
        arr3(t, T, num_density, 4.60e-27, 4.0e0, 0.0, 2.6e-11, 1.3e0, 0.0, 0.5e0),
        PRPE + OH --> PO2#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 5.50e-15, 0.0, -1880.0e0),
        PRPE + O3 -->
        0.500ALD2 +
        0.500CH2O +
        0.120CH3CHOO +
        ...
        0.560CO +
        0.280HO2 +
        0.360OH#==2015/09/25; Millet2015; DBM,EAM==#
        rGLYCOH_a(t, T, num_density, 8.00e-12),
        GLYC + OH -->
        0.732CH2O + 0.361CO2 + 0.505CO + 0.227OH + 0.773HO2 + 0.134GLYX + 0.134HCOOH#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        rGLYCOH_b(t, T, num_density, 8.00e-12), GLYC + OH --> HCOOH + OH + CO#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        arr(t, T, num_density, 4.59e-13, 0.0, -1156.0e0), PRPE + NO3 --> PRN1
        arr(t, T, num_density, 3.10e-12, 0.0, 340.0e0), GLYX + OH --> HO2 + 2.000CO#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        c(1.50e-11, T, num_density), MGLY + OH --> MCO3 + CO
        rGLYXNO3(t, T, num_density, 1.40e-12, -1860.0e0),
        ...
        arr(t, T, num_density, 2.50e-12, 0.0, 500.0e0), MCO3 + MCO3 --> 2.000MO2
        arr(t, T, num_density, 1.80e-12, 0.0, 500.0e0), MCO3 + MO2 --> CH2O + MO2 + HO2
        arr(t, T, num_density, 2.00e-13, 0.0, 500.0e0), MCO3 + MO2 --> ACTA + CH2O
        arr(t, T, num_density, 1.68e-12, 0.0, 500.0e0),
        R4O2 + MCO3 -->
        MO2 +
        0.320ACET +
        ...
        0.050A3O2 +
        0.180B3O2 +
        0.320OTHRO2#==2013/03/22; Paulot2009; FP,EAM,JMAO,MJE==#
        ...
        arr(t, T, num_density, 2.50e-12, 0.0, 500.0e0),
        RCO3 + MCO3 --> MO2 + 0.500OTHRO2 + 0.070A3O2 + 0.270B3O2#==2019/05/10; Fisher2018; JAF==#
        arr(t, T, num_density, 8.50e-13, 0.0, -2450.0e0), NO3 + NO3 --> 2.000NO2 + O2
        arr3(t, T, num_density, 1.00e-30, 4.8e+00, 0.0, 7.2e-12, 2.1e0, 0.0, 0.6e0),
        ...
        arr(t, T, num_density, 4.50e-12, 0.0, 460.0e0), BrO + HO2 --> HOBr + O2#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 4.80e-12, 0.0, -310.0e0), Br + HO2 --> HBr + O2#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 5.50e-12, 0.0, 200.0e0), HBr + OH --> Br + H2O#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 2.40e-12, 0.0, 40.0e0), BrO + BrO --> 2.000Br + O2#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 2.80e-14, 0.0, 860.0e0), BrO + BrO --> Br2 + O2#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 8.80e-12, 0.0, 260.0e0), BrO + NO --> Br + NO2#==2012/06/07; Parrella2012; JPP==#
        c(4.90e-11, T, num_density), Br + BrNO3 --> Br2 + NO3#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 2.10e-11, 0.0, 240.0e0), Br2 + OH --> HOBr + Br#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 1.20e-10, 0.0, -430.0e0), HOBr + O --> OH + BrO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 5.80e-12, 0.0, -1500.0e0), HBr + O --> OH + Br#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.70e-11, 0.0, 250.0e0), BrO + OH --> Br + HO2#==2012/06/07; Parrella2012; JPP==#
        c(1.60e-11, T, num_density), Br + NO3 --> BrO + NO2#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 1.70e-11, 0.0, -800.0e0), Br + CH2O --> HBr + HO2 + CO#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 1.80e-11, 0.0, -460.0e0), Br + ALD2 --> HBr + MCO3#==2017/07/27; Parrella2012,Fix C creation; SAS,BHH,MJE==#
        ...
        arr3(t, T, num_density, 4.20e-31, 2.4e0, 0.0, 2.7e-11, 0.0, 0.0, 0.6e0),
        Br + NO2 --> BrNO2#==2012/06/07; Parrella2012; JPP==#
        arr3(t, T, num_density, 5.40e-31, 3.1e0, 0.0, 6.5e-12, 2.9e0, 0.0, 0.6e0),
        BrO + NO2 --> BrNO3#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 9.00e-13, 0.0, -360.0e0), CHBr3 + OH --> 3.000Br#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 2.00e-12, 0.0, -840.0e0), CH2Br2 + OH --> 2.000Br#==2012/06/07; Parrella2012; JPP==#
        arr(t, T, num_density, 1.42e-12, 0.0, -1150.0e0), CH3Br + OH --> Br + H2O + HO2#==2017/03/08; JPL 15-10; TS,BHH,MJE==#
        arr(t, T, num_density, 1.63e-10, 0.0, 60.0e0), O1D + H2O --> 2.000OH#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.15e-11, 0.0, 110.0e0), O1D + N2 --> O + N2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.30e-11, 0.0, 55.0e0), O1D + O2 --> O + O2#==2014/02/03; Eastham2014; SDE==#
        c(1.20e-10, T, num_density), O1D + H2 --> H + OH#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 4.63e-11, 0.0, 20.0e0), O1D + N2O --> N2 + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 7.25e-11, 0.0, 20.0e0), O1D + N2O --> 2.000NO#==2014/02/03; Eastham2014; SDE==#
        ...
        arr(t, T, num_density, 3.00e-11, 0.0, 200.0e0), HO2 + O --> OH + O2#==2014/02/03; Eastham2014; SDE==#
        c(1.20e-10, T, num_density), O1D + O3 --> 2.000O2#==2014/02/03; Eastham2014; SDE==#
        c(1.20e-10, T, num_density), O1D + O3 --> 2.000O + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.10e-11, 0.0, -2200.0e0), OCS + O --> CO + SO2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.10e-13, 0.0, -1200.0e0), OCS + OH --> CO2 + SO2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 5.10e-12, 0.0, 210.0e0), NO2 + O --> NO + O2#==2014/02/03; Eastham2014; SDE==#
        c(1.00e-11, T, num_density), NO3 + O --> NO2 + O2#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 9.00e-32, 1.5e+00, 0.0, 3.0e-11, 0.0, 0.0, 0.6e0),
        NO + O --> NO2#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 2.50e-31, 1.8e+00, 0.0, 2.2e-11, 0.7e0, 0.0, 0.6e0),
        NO2 + O --> NO3#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.40e-12, 0.0, -2000.0e0), H2O2 + O --> OH + HO2#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 4.40e-32, 1.3e+00, 0.0, 7.5e-11, -0.2e0, 0.0, 0.6e0),
        H + O2 --> HO2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.40e-10, 0.0, -470.0e0), H + O3 --> OH + O2#==2014/02/03; Eastham2014; SDE==#
        c(7.20e-11, T, num_density), H + HO2 --> 2.000OH#==2014/02/03; Eastham2014; SDE==#
        c(1.60e-12, T, num_density), H + HO2 --> O + H2O#==2014/02/03; Eastham2014; SDE==#
        c(6.90e-12, T, num_density), H + HO2 --> H2 + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.50e-11, 0.0, -3600.0e0), N + O2 --> NO + O#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.10e-11, 0.0, 100.0e0), N + NO --> N2 + O#==2014/02/03; Eastham2014; SDE==#
        ...
        arr(t, T, num_density, 1.80e-11, 0.0, -600.0e0), MO2 + ClO --> ClOO + HO2 + CH2O#==2017/03/20; JPL 15-10; TS,BHH,MJE==#
        arr(t, T, num_density, 7.40e-12, 0.0, 270.0e0), OH + ClO --> HO2 + Cl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 6.00e-13, 0.0, 230.0e0), OH + ClO --> HCl + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.40e-12, 0.0, 600.0e0), OH + OClO --> HOCl + O2#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 6.00e-13, 0.0, 670.0e0), OH + Cl2O2 --> HOCl + ClOO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.80e-12, 0.0, -250.0e0), OH + HCl --> H2O + Cl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.00e-12, 0.0, -500.0e0), OH + HOCl --> H2O + ClO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.40e-12, 0.0, -1250.0e0), OH + ClNO2 --> HOCl + NO2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.20e-12, 0.0, -330.0e0), OH + ClNO3 --> HOCl + NO3#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.96e-12, 0.0, -1200.0e0), OH + CH3Cl --> Cl + HO2 + H2O#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 2.61e-12, 0.0, -944.0e0), OH + CH2Cl2 --> 2.000Cl + HO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 4.69e-12, 0.0, -1134.0e0), OH + CHCl3 --> 3.000Cl + HO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 1.64e-12, 0.0, -1520.0e0), OH + CH3CCl3 --> 3.000Cl + H2O#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 9.20e-13, 0.0, -1560.0e0), OH + HCFC22 --> Cl + H2O#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 1.25e-12, 0.0, -1600.0e0), OH + HCFC141b --> 2.000Cl + H2O#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.30e-12, 0.0, -1770.0e0), OH + HCFC142b --> Cl + H2O#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 7.40e-13, 0.0, -900.0e0), OH + HCFC123 --> 2.000Cl + H2O#==2017/02/22; JPL 15-10; BHH,MJE==#
        arr(t, T, num_density, 7.10e-12, 0.0, -1270.0e0), CH4 + Cl --> HCl + MO2#==2017/03/08; JPL 15-10; TS,BHH,MJE==#
        arr(t, T, num_density, 7.32e-11, 0.0, -30.0e0), CH2O + Cl --> CO + HCl + HO2#==2017/09/22; Sherwen2016b; TS,JAS,SDE==#
        arr(t, T, num_density, 2.30e-11, 0.0, -200.0e0), Cl + O3 --> ClO + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.05e-11, 0.0, -2270.0e0), Cl + H2 --> H + HCl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.10e-11, 0.0, -980.0e0), Cl + H2O2 --> HO2 + HCl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.40e-11, 0.0, 270.0e0), Cl + HO2 --> O2 + HCl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.60e-11, 0.0, -375.0e0), Cl + HO2 --> OH + ClO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.80e-11, 0.0, 85.0e0), ClO + O --> Cl + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.60e-12, 0.0, 290.0e0), ClO + HO2 --> O2 + HOCl#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 6.40e-12, 0.0, 290.0e0), ClO + NO --> Cl + NO2#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 1.80e-31, 3.4e+00, 0.0, 1.50e-11, 1.9e0, 0.0, 0.6e0),
        ClO + NO2 --> ClNO3#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 1.00e-12, 0.0, -1590.0e0), ClO + ClO --> Cl2 + O2#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.00e-11, 0.0, -2450.0e0), ClO + ClO --> Cl + ClOO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 3.50e-13, 0.0, -1370.0e0), ClO + ClO --> OClO + Cl#==2014/02/03; Eastham2014; SDE==#
        arr3(t, T, num_density, 2.20e-33, 3.1e+00, 0.0, 1.8e-10, 0.0, 0.0, 0.6e0),
        ...
        arr3(t, T, num_density, 1.90e-32, 3.6e+00, 0.0, 3.7e-12, 1.6e0, 0.0, 0.6e0),
        ...
        Cl2O2 --> 2.000ClO#==JPL 15-10; XW==#
        c(2.30e-10, T, num_density), ClOO + Cl --> Cl2 + O2#==2014/02/03; Eastham2014; SDE==#
        c(1.20e-11, T, num_density), ClOO + Cl --> 2.000ClO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 9.50e-13, 0.0, 550.0e0), ClO + BrO --> Br + OClO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 2.30e-12, 0.0, 260.0e0), ClO + BrO --> Br + ClOO#==2014/02/03; Eastham2014; SDE==#
        arr(t, T, num_density, 4.10e-13, 0.0, 290.0e0), ClO + BrO --> BrCl + O2#==2014/02/03; Eastham2014; SDE==#
        ...
        c(3.60e-12, T, num_density), Br + PRPE --> HBr + PO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr3(t, T, num_density, 1.80e-32, 1.0e0, 0.0, 1.77e-11, 0.0, 0.0, 0.6e0),
        I + NO --> INO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 8.40e-11, 0.0, -2620.0e0), INO + INO --> I2 + 2.000NO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr3(t, T, num_density, 3.00e-31, 1.0e0, 0.0, 6.6e-11, 0.0, 0.0, 0.63e0),
        ...
        arr(t, T, num_density, 2.90e-11, 0.0, -2600.0e0), IONO + IONO --> I2 + 2.000NO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(1.50e-12, T, num_density), I2 + NO3 --> I + IONO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr3(t, T, num_density, 7.50e-31, 3.5e0, 0.0, 7.6e-12, 1.5e0, 0.0, 0.6e0),
        ...
        arr(t, T, num_density, 9.10e-11, 0.0, -146.0e0), IONO2 + I --> I2 + NO3#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(1.20e-11, T, num_density), I + BrO --> IO + Br#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 3.00e-12, 0.0, 510.0e0), IO + BrO --> Br + I + O2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 1.20e-11, 0.0, 510.0e0), IO + BrO --> Br + OIO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(1.00e-10, T, num_density), IO + OIO --> I2O3#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(1.50e-10, T, num_density), OIO + OIO --> I2O4#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c1(3.80e-02), I2O4 --> 2.000OIO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 1.10e-12, 0.0, 542.0e0), OIO + NO --> IO + NO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 5.10e-12, 0.0, 280.0e0), IO + ClO --> I + OClO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        ...
        arr(t, T, num_density, 2.30e-11, 0.0, -870.0e0), I + O3 --> IO + O2#==2017/09/22; Sherwen2017;TS,JAS,SDE==#
        arr(t, T, num_density, 1.50e-11, 0.0, -1090.0e0), I + HO2 --> HI + O2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(1.80e-10, T, num_density), I2 + OH --> HOI + I#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(3.00e-11, T, num_density), HI + OH --> I + H2O#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(5.00e-12, T, num_density), HOI + OH --> IO + H2O#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 1.30e-11, 0.0, 570.0e0), IO + HO2 --> HOI + O2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 9.10e-12, 0.0, 240.0e0), IO + NO --> I + NO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 6.00e-12, 0.0, 500.0e0), IO + IO --> I + OIO#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        arr(t, T, num_density, 9.00e-12, 0.0, 500.0e0), IO + IO --> I2O2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        ...
        arr(t, T, num_density, 2.90e-12, 0.0, -1100.0e0), CH3I + OH --> H2O + I + MO2#==2017/09/22; Sherwen2016b;TS,JAS,SDE==#
        c(2.40e-12, T, num_density), ETHLN + OH --> CH2O + CO2 + NO2#==2017/06/15, Marais2016, EAM==#
        c(6.70e-13, T, num_density), PROPNN + OH --> NO2 + MGLY#==2017/07/14; MCMv3.3; KRT,JAF,CCM,EAM,KHB,RHS==#
        ...
        c(3.70e-11, T, num_density), CH2OO + SO2 --> CH2O + SO4#==2019/11/06; Bates2019; KHB==#
        c(1.20e-15, T, num_density), CH3CHOO + CO --> ALD2#==2015/09/25; Millet2015; DBM,EAM==#
        c(1.00e-14, T, num_density), CH3CHOO + NO --> ALD2 + NO2#==2015/09/25; Millet2015; DBM,EAM==#
        c(1.00e-15, T, num_density), CH3CHOO + NO2 --> ALD2 + NO3#==2015/09/25; Millet2015; DBM,EAM==#
        c(7.00e-14, T, num_density), CH3CHOO + SO2 --> ALD2 + SO4#==2015/09/25; Millet2015; DBM,EAM==#
        c(6.00e-18, T, num_density), CH3CHOO + H2O --> ALD2 + H2O2#==2015/09/25; Millet2015; DBM,EAM==#
        c(1.00e-17, T, num_density), CH3CHOO + H2O --> ACTA#==2015/09/25; Millet2015; DBM,EAM==#
        ...
        0.070HCOOH +
        0.120MONITS +
        0.060MONITU#==2017/07/14; Browne2014; KRT,JAF,CCM,EAM,KHB,RHS==#
        c(1.50e-11, T, num_density), PIO2 + HO2 --> PIP#==2017/03/23; Roberts1992; EVF==#
        arr(t, T, num_density, 3.56e-14, 0.0, 708.0e0),
        PIO2 + MO2 --> HO2 + 0.750CH2O + 0.250MOH + 0.250ROH + 0.750RCHO + 0.750MEK#==2017/07/14; Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 7.40e-13, 0.0, 765.0e0),
        PIO2 + MCO3 --> 0.500HO2 + 0.500MO2 + RCHO + MEK + RCOOH#==2017/03/23; Roberts1992; EVF==#
        c(1.20e-12, T, num_density), PIO2 + NO3 --> HO2 + NO2 + RCHO + MEK#==2017/03/23; Roberts1992; EVF==#
        arr(t, T, num_density, 5.00e-16, 0.0, -530.0e0),
        MTPA + O3 -->
        0.850OH + 0.100HO2 + 0.620KO2 + 0.140CO + 0.020H2O2 + 0.650RCHO + 0.530MEK#==2017/07/14; Atkinson2003; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 5.00e-16, 0.0, -530.0e0),
        MTPO + O3 -->
        0.850OH + 0.100HO2 + 0.620KO2 + 0.140CO + 0.020H2O2 + 0.650RCHO + 0.530MEK#==2017/07/14; Atkinson2003; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 8.33e-13, 0.0, 490.0e0), MTPA + NO3 --> 0.100OLNN + 0.900OLND#==2017/07/14; Fisher2016; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 8.33e-13, 0.0, 490.0e0), MTPO + NO3 --> 0.100OLNN + 0.900OLND#==2017/07/14; Fisher2016; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 4.20e-11, 0.0, 401.0e0), LIMO + OH --> LIMO2#==2017/07/14; Gill2002; KRT,JAF,CCM,EAM,KHB,RHS==#
        ...
        0.790MACR +
        0.010HCOOH +
        0.070RCOOH#==2017/07/14; Atkinson2003; KRT,JAF,CCM,EAM,KHB,RHS==#
        c(1.22e-11, T, num_density), LIMO + NO3 --> 0.500OLNN + 0.500OLND#==2017/07/14; Fry2014,Atkinson2003; KRT,JAF,CCM,EAM,KHB,RHS==#
        c(4.00e-12, T, num_density),
        LIMO2 + NO -->
        0.686HO2 +
        0.780NO2 +
        ...
        c(1.50e-11, T, num_density), LIMO2 + HO2 --> PIP#==2017/07/14; Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 3.56e-14, 0.0, 708.0e0),
        LIMO2 + MO2 --> HO2 + 0.192PRPE + 1.040CH2O + 0.308MACR + 0.250MOH + 0.250ROH#==2017/07/14; Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 7.40e-13, 0.0, 765.0e0),
        LIMO2 + MCO3 -->
        ...
        0.250ROH +
        0.350MONITS +
        0.150MONITU#==2017/07/14; Browne2014,Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        arr(t, T, num_density, 8.85e-13, 0.0, 765.0e0),
        OLNN + MCO3 --> HO2 + MO2 + 0.700MONITS + 0.300MONITU#==2017/07/14; Browne2014,Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        ...
        OLND + OLND --> NO2 + 0.504CH2O + 1.210RCHO + 0.285MEK + 0.700MONITS + 0.300MONITU#==2017/07/14; Browne2014,Roberts1992; KRT,JAF,CCM,EAM,KHB,RHS==#
        c(4.80e-12, T, num_density), MONITS + OH --> HONIT#==2017/07/14; Browne2014; KRT,JAF,CCM,EAM,KHB,RHS==#
        ...
        c1(2.78e-04), IONITA --> INDIOL + HNO3#==2017/07/14; Fisher2016; KRT,JAF,CCM,EAM,KHB,RHS==#
        c1(2.78e-04), MONITA --> INDIOL + HNO3#==2017/07/14; Fisher2016; KRT,JAF,CCM,EAM,KHB,RHS==#
        rOHHNO3(
            t,
            T,
            num_density,
        ...
        arr(t, T, num_density, 8.00e-13, 0.0, -1000.0e0), MENO3 + OH --> CH2O + NO2#==2019/05/16; JPL 15-10,Fisher2018; JAF==#
        arr(t, T, num_density, 1.00e-12, 0.0, -490.0e0), ETNO3 + OH --> ALD2 + NO2#==2019/05/16; JPL 15-10,Fisher2018; JAF==#
        arr(t, T, num_density, 1.20e-12, 0.0, -320.0e0), IPRNO3 + OH --> ACET + NO2#==2019/05/16; JPL 15-10,Fisher2018; JAF==#
        c(7.10e-13, T, num_density), NPRNO3 + OH --> RCHO + NO2#==2019/05/16; JPL 15-10,Fisher2018; JAF==#
        ...
        tunplsnodim(t, T, 2.22e9, -7.160e3, 1.0e8, -0.0306e0, 1.1346e-4),
        IHOO4 -->
        ...
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 1.19e0, 6.0e0, 1.1644e0, 7.05e-4),
        IHOO1 + NO --> IHN2#==2019/11/06; Bates2019; KHB==#
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 1.19e0, 6.0e0, 1.1644e0, 7.05e-4),
        IHOO1 + NO --> NO2 + MVK + HO2 + CH2O#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 1.421e0, 6.0e0, -0.1644e0, -7.05e-4),
        IHOO1 + NO --> IHN4#==2019/11/06; Bates2019; KHB==#
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 1.421e0, 6.0e0, -0.1644e0, -7.05e-4),
        IHOO1 + NO --> NO2 + 0.45HC5A + 0.45HO2 + 0.55MVKHP + 0.55CO + 0.55OH#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 1.297e0, 6.0e0, 1.2038e0, 9.04e-4),
        IHOO4 + NO --> IHN3#==2019/11/06; Bates2019; KHB==#
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 1.297e0, 6.0e0, 1.2038e0, 9.04e-4),
        IHOO4 + NO --> NO2 + MACR + HO2 + CH2O#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 1.421e0, 6.0e0, -0.2038e0, -9.04e-4),
        IHOO4 + NO --> IHN1#==2019/11/06; Bates2019; KHB==#
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 1.421e0, 6.0e0, -0.2038e0, -9.04e-4),
        ...
        arr(t, T, num_density, 2.20e-11, 0.0, 390.0e0),
        HPALD3 + OH --> OH + 0.230MVK + 0.420CO + 0.190MVKHP + 0.580ICHE#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 3.50e-11, 0.0, 390.0e0),
        HPALD4 + OH --> OH + 0.770ICHE + 0.230CO + 0.090MCRHP + 0.140MACR#==2019/11/06; Bates2019; KHB==#
        ...
        arr(t, T, num_density, 3.00e-12, 0.0, 650.0e0), IDC + OH --> CO + HO2 + MVKPC#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 2.47e-12, 0.0, 390.0e0),
        RIPA + OH --> 0.655IHPOO3 + 0.345IHPOO1 + 0.005LVOC#==2019/11/06; Bates2019; KHB==#
        rEPO(t, T, num_density, 1.62e-11, 3.90e2, 4.77e-21),
        ...
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 2.1e0, 9.0e0, 1.0e0, 0.0e0),
        IHPOO1 + NO --> 0.716MCRHP + 0.716CH2O + 0.284HPETHNL + 0.284HAC + NO2 + HO2#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 2.1e0, 9.0e0, 1.0e0, 0.0e0),
        ...
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 2.315e0, 9.0e0, 1.0e0, 0.0e0),
        IHPOO2 + NO --> 0.706MVKHP + 0.706CH2O + 0.294GLYC + 0.294ATOOH + NO2 + HO2#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 2.315e0, 9.0e0, 1.0e0, 0.0e0),
        ...
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 3.079e0, 9.0e0, 1.0e0, 0.0e0),
        IHPOO3 + NO --> GLYC + HAC + NO2 + OH#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 3.079e0, 9.0e0, 1.0e0, 0.0e0),
        ...
        rEPO(t, T, num_density, 3.75e-11, -4.00e2, 8.91e-21),
        ...
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 13.098e0, 8.0e0, 1.0e0, 0.0e0),
        ...
        rALK(t, T, num_density, 2.7e-12, 3.50e2, 16.463e0, 8.0e0, 1.0e0, 0.0e0),
        IEPOXBOO + NO --> NO2 + HO2 + 0.8GLYX + 0.8HAC + 0.2CO + 0.2MCRDH#==2019/11/06; Bates2019; KHB==#
        rNIT(t, T, num_density, 2.7e-12, 3.50e2, 16.463e0, 8.0e0, 1.0e0, 0.0e0),
        ...
        arr(t, T, num_density, 2.60e-13, 0.0, 1300.0e0),
        ISOPNOO1 + HO2 -->
        0.482ITHN +
        0.059MCRHN +
        0.059CH2O +
        ...
        INO2B + INO2B -->
        1.737MVK + 0.123MACR + 1.860CH2O + 1.860NO2 + 0.070INPB + 0.070ICN#==2019/11/06; Bates2019; KHB==#
        ...
        arr(t, T, num_density, 3.40e-12, 0.0, 200.0e0), INPD + OH --> INO2D#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 7.50e-12, 0.0, 20.0e0), INPD + OH --> ICN + OH#==2019/11/06; Bates2019; KHB==#
        ...
        arr(t, T, num_density, 2.60e-12, 0.0, 610.0e0), MVK + OH --> MVKOHOO#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 8.50e-16, 0.0, -1520.0e0),
        MVK + O3 -->
        0.545MGLY +
        0.500CH2OO +
        0.600CH2O +
        ...
        arr(t, T, num_density, 4.40e-12, 0.0, 380.0e0),
        MACR + OH --> 0.036ATOOH + 0.036CO + 0.036HO2 + 0.964MCROHOO#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 2.70e-12, 0.0, 470.0e0), MACR + OH --> MACR1OO#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 1.40e-15, 0.0, -2100.0e0),
        MACR + O3 --> 0.880MGLY + 0.880CH2OO + 0.120CH2O + 0.120OH + 0.120CO + 0.120MCO3#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 1.80e-13, 0.0, -1190.0e0),
        MACR + NO3 --> 0.320HNO3 + 0.320MACR1OO + 0.680OH + 0.680CO + 0.680PROPNN#==2019/11/06; Bates2019; KHB==#
        ...
        0.290MVKHCB +
        0.310NO2 +
        0.040MCO3#==2019/11/06; Bates2019; KHB==#
        ...
        arr(t, T, num_density, 2.70e-12, 0.0, 350.0e0), C4HVP2 + NO --> NO2 + MCROHOO#==2019/11/06; Bates2019; KHB==#
        arr(t, T, num_density, 1.93e-13, 0.0, 1300.0e0), C4HVP2 + HO2 --> OH + MCROHOO#==2019/11/06; Bates2019; KHB==#
        c(9.00e-12, T, num_density), C4HVP2 + NO2 --> MCRHN#==2019/11/06; Bates2019; KHB==#
        ...
        0.335MVKHP +
        0.050MGLY +
        0.050CH2O#==2019/11/06; Bates2019; KHB==#
        ...
        arr(t, T, num_density, 7.50e-12, 0.0, 290.0e0), MACRNO2 + NO --> HAC + 2NO2 + CO2#==2019/11/06; Bates2019; KHB==#
        rPAN_acac(t, T, num_density, 2.591e-28, -6.87e0, 1.125e-11, -1.105e0, 0.3e0),
        MACRNO2 + NO2 --> MPAN + NO2#==2019/11/06; Bates2019; KHB==#
        c(4.00e-12, T, num_density), MACRNO2 + NO3 --> HAC + 2NO2 + CO2#==2019/11/06; Bates2019; KHB==#
        ...
        c(3.00e-12, T, num_density), IDHDP + OH --> OH + 0.333ICPDH + 0.667IDHPE#==2019/11/06; Bates2019; KHB==#
        c(3.00e-12, T, num_density), IDHPE + OH --> OH + CO2 + 0.571MCRHP + 0.429MVKHP#==2019/11/06; Bates2019; KHB==#
        c(1.00e-11, T, num_density), ITCN + OH --> CO + NO2 + 0.75MVKHP + 0.25MCRHP#==2019/11/06; Bates2019; KHB==#
        c(3.00e-12, T, num_density),
        ITHN + OH -->
        0.300OH +
        0.620HO2 +
        0.920ITCN +
        ...
        arr(t, T, num_density, 1.40e-12, 0.0, 700.0e0), NRO2 + HO2 --> LNRO2H + HO2#==2013/08/12; Pye2010; HOTP==#
        arr(t, T, num_density, 2.60e-12, 0.0, 350.0e0), NRO2 + NO --> LNRO2N + NO#==2013/08/12; Pye2010; HOTP==#

        # --- C2H2 & C2H4 chemistry (per KHB)
        arr(t, T, num_density, 9.10e-15, 0.0e0, -2580.0e0), C2H4 + O3 --> CH2O + CH2OO#==2021/09/22; Kwon2020; KHB,MSL==#
        arr3(t, T, num_density, 1.10e-28, 3.5e+00, 0.0, 8.4e-12, 1.75e0, 0.0, 0.5e0),
        ...
        arr(t, T, num_density, 1.90e-12, 0.0e+00, 190.0e0), ETHP + OH --> ETOO#==2021/09/22; Kwon2020; KHB,MSL==#
        ...
        arr(t, T, num_density, 4.20e-14, 0.0e0, 220.0e0), AROMRO2 + MCO3 --> MO2 + HO2#==2021/09/29; Bates2021b; KHB,MSL==#
        ...
        arr(t, T, num_density, 7.50e-12, 0.0e0, 290.0e0), BZCO3 + NO --> NO2 + CO2 + BENZO2#==2021/09/29; Bates2021b; KHB,MSL==#
        ...
        c(7.00e-12, T, num_density), BENZO2 + NO2 --> BENZO + NO3#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 2.670e-12, 0.0e0, 365.0e0), BENZO2 + NO --> BENZO + NO2#==2021/09/29; Bates2021b; KHB,MSL==#
        c(2.30e-12, T, num_density), BENZO2 + NO3 --> BENZO + NO2#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 2.24e-13, 0.0e0, 1300.0e0), BENZO2 + HO2 --> BENZP#==2021/09/29; Bates2021b; KHB,MSL==#
        c(3.60e-12, T, num_density), BENZP + OH --> BENZO2#==2021/09/29; Bates2021b; KHB,MSL==#
        ...
        #
        arr(t, T, num_density, 1.40e-12, 0.0e0, 700.0e0), BRO2 + HO2 --> HO2 + LBRO2H#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 2.60e-12, 0.0e0, 350.0e0), BRO2 + NO --> NO + LBRO2N#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 1.40e-12, 0.0e0, 700.0e0), TRO2 + HO2 --> HO2 + LTRO2H#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 2.60e-12, 0.0e0, 350.0e0), TRO2 + NO --> NO + LTRO2N#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 1.40e-12, 0.0e0, 700.0e0), XRO2 + HO2 --> HO2 + LXRO2H#==2021/09/29; Bates2021b; KHB,MSL==#
        arr(t, T, num_density, 2.60e-12, 0.0e0, 350.0e0), XRO2 + NO --> NO + LXRO2N#==2021/09/29; Bates2021b; KHB,MSL==#
        c(1.20e-12, T, num_density), MO2 + NO3 --> NO2 + CH2O + HO2#==2022/10/18: IUPAC ROO_19; KHB,BMY==#
        #
        # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
