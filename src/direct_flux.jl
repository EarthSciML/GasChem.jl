...
const σ_Raylay = SA_F32[
    ...
    4.514 * 0.1,
    3.643 * 0.1,
    1.387 * 0.1,   # bin 17 (429 nm, Cloud-J v8.0; was 2.087e-26 @ legacy 380 nm)
    3.136 * 0.01,  # bin 18 (631 nm, v8.0; was 3.848e-27 @ legacy 574 nm)
] * 10.0f0^-25.0f0
...
const σ_O3_interp = create_fjx_interp(
    ...
    [
        SA_F32[
            ...
            3.661 * 0.1,
            4.539 * 0.01,
            2.125 * 0.001,  # bin 17 (429 nm, v8.0 Chappuis; was 6.167e-23 @ 380 nm)
            2.325 * 0.01,   # bin 18 (631 nm, v8.0; was 1.666e-21 @ 574 nm)
        ] * 10.0f0^-19.0f0,
        SA_F32[
            5.989,
            4.862,
