...
function Pollu(; name = :Pollu, rxn_sys = false)
    rx_sys = @reaction_network Pollu begin
        ...
        @parameters begin
            ...
            k2       = 0.266e2 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            k3       = 0.123e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"] # updated to match Fontana pollu.f
            jH2COa   = 0.86e-3 / 60.0,      [unit = u"s^-1"]
            jH2COb   = 0.82e-3 / 60.0,      [unit = u"s^-1"]
            k6       = 0.15e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            jALD     = 0.13e-3 / 60.0,      [unit = u"s^-1"]
            k8       = 0.24e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            k9       = 0.165e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            k10      = 0.9e4 / (60.0 * 1e3),  [unit = u"1/(ppb*s)"]
            jPAN     = 0.22e-1 / 60.0,      [unit = u"s^-1"]
            k12      = 0.12e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            k13      = 1.88 / 60.0,         [unit = u"1/s"]
            k14      = 0.163e5 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            ...
            k20      = 0.124e4 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            jNO3_NO  = 0.21e1 / 60.0,       [unit = u"s^-1"]
            jNO3_NO2 = 0.578e1 / 60.0,      [unit = u"s^-1"]
            k23      = 0.474e-1 / (60.0 * 1e3), [unit = u"1/(ppb*s)"]
            k24      = 0.178e4 / (60.0 * 1e3),  [unit = u"1/(ppb*s)"]
