...
using GasChem: PlanetaryEnergyBalance, ClimateSensitivity, TOARadiativeForcing, RadiationFundamentals
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_bb],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(p)) for p in params_bb],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_wien],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_sb],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_balance],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(p)) for p in params_balance],
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_sensitivity],
...
Implements the top of atmosphere radiative forcing (Eq. 4.11):
...
DataFrame(
    ...
    :Units => [string(ModelingToolkit.get_unit(v)) for v in vars_toa],
...
DataFrame(
    ...
    :Equations => ["Eq. 4.1", "Eq. 4.2", "Eq. 4.3", "Eq. 4.4", "Eqs. 4.5-4.7", "Eqs. 4.8-4.10", "Eq. 4.11"]
)
```
...
DataFrame(
    ...
    :Spectral_Region => ["Visible (yellow)", "Near-IR", "Near-IR", "Mid-IR", "Thermal IR", "Thermal IR"]
)
```
